...
class ApiServicesCall extends GetConnect {
  ...
  Future<List<dynamic>> getDomaineAffectation() async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.BASE_URL}/ParametreSociete/ListeDomaineAffectation?avec_emp=1&avec_formation=1&avec_audit=1&avec_action=1&avec_document=1&avec_reunion=1&avec_fournisseur=1&avec_reclamation=1&avec_indicateur=1&avec_equipement=1&avec_non_conformite=1&avec_coq=1&avec_environnement=1&avec_haccp=1&avec_courrier=1&avec_amdec=1&avec_securite=1&avec_conf_reg=1&avec_part_int=1&avec_client=1&avec_risque=1&avec_changement=1&avec_Conformite=1&avec_Achat=1'),
          headers: {
  ...
  Future<List<dynamic>> getChampObligatoireAction() async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.PARAMETRE_SOCIETE_URL}/GetChampsObligatoireAction'),
          headers: {
            'Content-Type':' application/json'
          }
      );
  ...
  Future<List<dynamic>> getSourceAction() async {
    try {
      var response = await http.post(
          Uri.parse('${AppConstants.ACTION_URL}/AllSource'),
          //body: json.encode(data),
          headers: {
            'Content-Type':' application/json'
          }
  ...
  Future<List<dynamic>> getSiteOffline(matricule) async {
    try {
      //print('data : ${json.encode(data)}');
      var response = await http.get(
          Uri.parse('${AppConstants.SITE_URL}/SiteEmployeRestriction?mat=$matricule'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getProcessusOffline(matricule) async {
    try {
      //print('data : ${json.encode(data)}');
      var response = await http.get(
          Uri.parse('${AppConstants.PROCESSUS_URL}/ProcessusParFicheEtEmploye?mat=$matricule'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getDirectionOffline(matricule) async {
    try {
      //print('data : ${json.encode(data)}');
      var response = await http.get(
          Uri.parse('${AppConstants.DIRECTION_URL}/DirectionParFicheEtEmploye?mat=$matricule'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getService(matricule, direction, module, fiche) async {
    try {
      print(Uri.parse('${AppConstants.SERVICE_URL}/ServiceParFicheEtEmployeEtDirection?mat=$matricule&CodeDirection=$direction&Module=$module&Fiche=$fiche'));
      var response = await http.get(
          Uri.parse(
  ...
  Future<List<dynamic>> getActivityOffline(matricule) async {
    try {
      //print('data : ${json.encode(data)}');
      var response = await http.get(
          Uri.parse('${AppConstants.ACTIVITY_URL}/DomaineParFicheEtEmploye?mat=$matricule'),
          headers: {
            'Content-Type':'application/json'
          }
      );
...
//get gravite
  ...
  Future<List<dynamic>> getResponsableRealisation(Map data) async {
    try {
      print('data : ${json.encode(data)}');
      var response = await http.post(
          Uri.parse('${AppConstants.SOUS_ACTION_URL}/SelectResponsableRealisation'),
          body: json.encode(data),
          headers: {
            'Content-Type':' application/json'
          }
  ...
  Future<List<dynamic>> getProcessusByMatricule(mat) async {
    try {
      ...
      var response = await http.get(
          Uri.parse('${AppConstants.SOUS_ACTION_URL}/GetProcessusSousAction?mat=$mat'),
          headers: {
            'Content-Type':' application/json'
          }
      );
  ...
  Future<dynamic> getChampObligatoirePNC() async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.PARAMETRE_SOCIETE_URL}/GetChampsObligatoirePnc'),
          headers: {
            'Content-Type':' application/json'
          }
      );
