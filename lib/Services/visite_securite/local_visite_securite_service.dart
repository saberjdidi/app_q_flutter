...
class LocalVisiteSecuriteService {
  ...
  Future<List<VisiteSecuriteModel>> readListVisiteSecuriteByOnline() async {
    ...
    return result.map((
            (e) => VisiteSecuriteModel.fromDBLocal(e)
    )).toList();
  }
  ...
  saveVisiteSecurite(VisiteSecuriteModel model) async {
    return await dbHelper.insertVisiteSecurite(DBTable.visite_securite, model.dataMap());
  }
  saveVisiteSecuriteSync(VisiteSecuriteModel model) async {
    return await dbHelper.insertVisiteSecurite(DBTable.visite_securite, model.dataMapSync());
  }
  ...
  readVisiteSecuriteById(numero) async {
    return await dbHelper.readVisiteSecuriteById(DBTable.visite_securite, numero);
  }
  ...
  readUniteVisiteSecurite() async {
    return await dbHelper.readUniteVisiteSecurite(DBTable.unite_visite_securite);
  }
  saveUniteVisiteSecurite(UniteModel model) async {
    return await dbHelper.insertUniteVisiteSecurite(DBTable.unite_visite_securite, model.dataMap());
  }
  ...
  saveZoneVisiteSecurite(ZoneModel model) async {
    return await dbHelper.insertZoneVisiteSecurite(DBTable.zone_visite_securite, model.dataMap());
  }
  ...
  saveSiteVisiteSecurite(SiteModel model) async {
    return await dbHelper.insertSiteVisiteSecurite(DBTable.site_visite_securite, model.dataMapVisiteSecurite());
  }
  ...
  readEquipeVisiteSecurite() async {
    return await dbHelper.readEquipeVisiteSecurite(DBTable.equipe_visite_securite);
  }
  saveEquipeVisiteSecurite(EquipeVisiteSecuriteModel model) async {
    return await dbHelper.insertEquipeVisiteSecurite(DBTable.equipe_visite_securite, model.dataMap());
  }
  ...
  readEquipeVisiteSecuriteEmploye() async {
    return await dbHelper.readEquipeVisiteSecuriteEmploye(DBTable.equipe_visite_securite_employe);
  }
  readEquipeVisiteSecuriteEmployeById(idVisite) async {
    return await dbHelper.readEquipeVisiteSecuriteEmployeById(idVisite);
  }
  Future<List<EquipeModel>> readListEquipeVisiteSecuriteEmployeById(idVisite) async {
    final response =  await dbHelper.readEquipeVisiteSecuriteEmployeById(idVisite);
    final List result = response;
    return result.map((
            (e) => EquipeModel.fromDBLocal(e)
    )).toList();
  }
  saveEquipeVisiteSecuriteEmploye(EquipeModel model) async {
    return await dbHelper.insertEquipeVisiteSecuriteEmploye(DBTable.equipe_visite_securite_employe, model.dataMapToSync());
  }
  ...
  readEquipeVisiteSecuriteOffline() async {
    return await dbHelper.readEquipeVisiteSecuriteOffline(DBTable.equipe_visite_securite_offline);
  }
  ...
  saveEquipeVisiteSecuriteOffline(EquipeVisiteSecuriteModel model) async {
    return await dbHelper.insertEquipeVisiteSecuriteOffline(DBTable.equipe_visite_securite_offline, model.dataMapOffline());
  }
