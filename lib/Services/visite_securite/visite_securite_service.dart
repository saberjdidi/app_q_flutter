...
class VisiteSecuriteService {
  ...
  Future<List<dynamic>> getVisiteSecurite(matricule) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/ListeVisite?Mat=$matricule'),
          headers: {
  ...
  //search data
  Future<List<dynamic>> searchVisiteSecurite(numero, unite, zone, matricule) async {
    try {
      print('${AppConstants.VISITE_SECURETE_URL}/ListeVisite?Num=$numero&Unite=$unite&Zone=$zone&Mat=$matricule');
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/ListeVisite?Num=$numero&Unite=$unite&Zone=$zone&Mat=$matricule'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getZoneByUnite(idUnite) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/GetZoneByUnite?IdUnite=$idUnite'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getSiteVisiteSecurite(matricule) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.SITE_URL}/SiteVisiteSecurite?mat=$matricule'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getCheckListCritere(idFiche) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/ListVisiteCheckList?idFiche=$idFiche'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<dynamic> getTauxRespect(idFiche) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/TauxRespectVisite?idViste=$idFiche'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getEquipeVisiteSecurite(idFiche) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/ListEquipeVisite?idFiche=$idFiche'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<dynamic> deleteEquipeVisiteSecuriteById(idFiche, mat) async {
    try {
      print('${AppConstants.VISITE_SECURETE_URL}/DeleteEquipeVisite?IdFiche=$idFiche&Mat=$mat');
      var response = await http.delete(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/DeleteEquipeVisite?IdFiche=$idFiche&Mat=$mat'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<List<dynamic>> getActionsVisiteSecurite(idFiche) async {
    try {
      var response = await http.get(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/ListActionByVisite?idFiche=$idFiche'),
          headers: {
            'Content-Type':'application/json'
          }
      );
  ...
  Future<dynamic> deleteActionVisiteSecuriteById(idFiche, idAction) async {
    try {
      print('${AppConstants.VISITE_SECURETE_URL}/DeleteActionVisite?IdFiche=$idFiche&IdAct=$idAction');
      var response = await http.delete(
          Uri.parse('${AppConstants.VISITE_SECURETE_URL}/DeleteActionVisite?IdFiche=$idFiche&IdAct=$idAction'),
          headers: {
            'Content-Type':'application/json'
          }
      );
