...
class IncidentSecuriteService {
  ...
  Future<List<dynamic>> getIncident(matricule) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listeIncidents?Mat=$matricule'),
  ...
  Future<List<dynamic>> searchIncident(
      matricule, numero, designation, type) async {
    try {
      print(
          '${AppConstants.INCIDENT_SECURETE_URL}/listeIncidents?Mat=$matricule&Ref=$numero&Designation=$designation&type=$type');
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listeIncidents?Mat=$matricule&Ref=$numero&Designation=$designation&type=$type'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<dynamic> saveIncident(Map data) async {
    try {
      ...
      if (kDebugMode)
        print(Uri.parse(
            '${AppConstants.INCIDENT_SECURETE_URL}/AddIncidentSecurite'));
  ...
  Future<dynamic> getChampObligatoireIncidentSecurite() async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.PARAMETRE_SOCIETE_URL}/ChampsObligatoireIncidentSec'),
          headers: {'Content-Type': ' application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getGraviteIncidentSecurite() async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listeGraviteIncident'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getEvenementDeclencheurIncidentSecurite() async {
    try {
      ...
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listEvenementsDeclencheurs'),
          headers: {'Content-Type': 'application/json'});
      print('response : ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getTypeCauseIncSecRattacher(
      idIncident, mat, online) async {
    try {
      debugPrint(
          '${AppConstants.INCIDENT_SECURETE_URL}/listTypeCauseIncSecRattacher?idIncident=$idIncident&mat=$mat&online=$online');
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listTypeCauseIncSecRattacher?idIncident=$idIncident&mat=$mat&online=$online'),
          headers: {'Content-Type': 'application/json'});
      ...
      return Future.error(
          'service type cause Inc Sec : ${exception.toString()}');
    }
  }
  ...
  Future<List<dynamic>> getTypeCauseIncSecARattacher(idIncident, mat) async {
    try {
      debugPrint(
          '${AppConstants.INCIDENT_SECURETE_URL}/listTypeCauseIncSecARattacher?idIncident=$idIncident&mat=$mat');
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listTypeCauseIncSecARattacher?idIncident=$idIncident&mat=$mat'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<dynamic> deleteTypeCauseIncidentById(idIncident, idCause) async {
    try {
      print(
          '${AppConstants.INCIDENT_SECURETE_URL}/DeleteCause?idIncident=$idIncident&idCause=$idCause');
  ...
  Future<List<dynamic>> getTypeConsequenceIncidentSecurite() async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/GetlisteConsequence'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getTypeConsequenceIncSecRattacher(
      idIncident, mat, online) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listTypeConsequenceIncSecRattacher?idIncident=$idIncident&mat=$mat&online=$online'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
      ...
      return Future.error(
          'service type consec Inc Sec: ${exception.toString()}');
    }
  }

  Future<List<dynamic>> getTypeConsequenceIncSecARattacher(
      idIncident, mat) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listTypeConsequenceIncSecARattacher?idIncident=$idIncident&mat=$mat'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<dynamic> saveTypeConseqenceByIncident(Map data) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/AddConsequenceByIncident'),
          body: json.encode(data),
          headers: {'Content-Type': 'application/json'});
      //print(AppConstants.ACTION_URL);
      print('response ${jsonDecode(response.body)}');
  ...
  Future<dynamic> deleteTypeConsequenceIncidentById(
      idIncedent, idConsequence) async {
    try {
      print(
          '${AppConstants.INCIDENT_SECURETE_URL}/DeleteConsequence?idIncident=$idIncedent&idConsequence=$idConsequence');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/DeleteConsequence?idIncident=$idIncedent&idConsequence=$idConsequence'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getCauseTypiqueIncSecARattacher(incident, mat) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listCauseTypiqueARattacher?idIncident=$incident&mat=$mat'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getCauseTypiqueIncSecRattacher(
      idIncident, mat, online) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listCauseTypiqueRattacher?idIncident=$idIncident&mat=$mat&online=$online'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<dynamic> saveCauseTypiqueByIncident(Map data) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/AddCauseTypiqueByIncident'),
          body: json.encode(data),
          headers: {'Content-Type': 'application/json'});
      //print(AppConstants.ACTION_URL);
      print('response ${jsonDecode(response.body)}');
  ...
  Future<dynamic> deleteCauseTypiqueIncidentById(
      idIncedent, idCauseTypique) async {
    try {
      print(
          '${AppConstants.INCIDENT_SECURETE_URL}/DeleteCauseTypique?idIncident=$idIncedent&idCauseTypique=$idCauseTypique');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/DeleteCauseTypique?idIncident=$idIncedent&idCauseTypique=$idCauseTypique'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getSiteLesionIncidentSecurite(idIncident, mat) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listSiteLesionARattacher?idIncident=$idIncident&mat=$mat'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getSiteLesionIncSecRattacher(
      idIncident, mat, online) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listSiteLesionRattacher?idIncident=$idIncident&mat=$mat&online=$online'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<dynamic> saveSiteLesionByIncident(Map data) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/AddSiteLesionByIncident'),
          body: json.encode(data),
          headers: {'Content-Type': 'application/json'});
      //print(AppConstants.ACTION_URL);
      print('response ${jsonDecode(response.body)}');
  ...
  Future<dynamic> deleteSiteLesionIncidentById(idIncedent, idSiteLesion) async {
    try {
      print(
          '${AppConstants.INCIDENT_SECURETE_URL}/DeleteSiteLesion?idIncident=$idIncedent&idSiteLesion=$idSiteLesion');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/DeleteSiteLesion?idIncident=$idIncedent&idSiteLesion=$idSiteLesion'),
          headers: {'Content-Type': 'application/json'});
  ...
  //Agenda
  //Decision Traitement
  Future<List<dynamic>> getListIncidentSecuriteDecisionTraitement(
      matricule) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listeIncidDecision?mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<dynamic> validerIncidentSecuriteDecisionTraitement(Map data) async {
    try {
      print('data : ${json.encode(data)}');
      print(Uri.parse(
          '${AppConstants.INCIDENT_SECURETE_URL}/ValidIncidDecisionTraitement'));
      var response = await http.post(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/ValidIncidDecisionTraitement'),
          body: json.encode(data),
  ...
  Future<List<dynamic>> getResponsableCloture(site, processus) async {
    try {
      print(Uri.parse(
          '${AppConstants.INCIDENT_SECURETE_URL}/RespCloture?idSite=$site&idProcessus=$processus'));
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/RespCloture?idSite=$site&idProcessus=$processus'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getListIncidentSecuriteATraiter(matricule) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listeIncidTraiter?mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<dynamic> validerIncidentSecuriteATraiter(Map data) async {
    try {
      print('data : ${json.encode(data)}');
      print(Uri.parse(
          '${AppConstants.INCIDENT_SECURETE_URL}/ValidIncid_aTraiter'));
      var response = await http.post(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/ValidIncid_aTraiter'),
          body: json.encode(data),
  ...
  Future<List<dynamic>> getListIncidentSecuriteACloturer(matricule) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/listeIncidCloturer?mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<dynamic> validerIncidentSecuriteACloturer(Map data) async {
    try {
      print('data : ${json.encode(data)}');
      print(Uri.parse(
          '${AppConstants.INCIDENT_SECURETE_URL}/ValidIncidCloturer'));
      var response = await http.post(
  ...
  //action
  Future<List<dynamic>> getActionsIncidentSecurite(idFiche, online) async {
    try {
      debugPrint(
          '${AppConstants.INCIDENT_SECURETE_URL}/ListActionIncidentSecu?Ref=$idFiche&online=$online');
      var response = await http.get(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/ListActionIncidentSecu?Ref=$idFiche&online=$online'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<dynamic> saveActionIncidentSecurite(Map data) async {
    try {
      print('data : ${json.encode(data)}');
      print(Uri.parse(
          '${AppConstants.INCIDENT_SECURETE_URL}/AddActionIncidentSecu'));
      var response = await http.post(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/AddActionIncidentSecu'),
          body: json.encode(data),
  ...
  Future<dynamic> deleteActionIncidentSecuriteById(idAction, idFiche) async {
    try {
      print(
          '${AppConstants.INCIDENT_SECURETE_URL}/DeleteActionIncidentSecu?Nact=$idAction&Ref=$idFiche');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.INCIDENT_SECURETE_URL}/DeleteActionIncidentSecu?Nact=$idAction&Ref=$idFiche'),
          headers: {'Content-Type': 'application/json'});
