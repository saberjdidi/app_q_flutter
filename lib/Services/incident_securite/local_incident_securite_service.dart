...
class LocalIncidentSecuriteService {
  ...
  Future<List<IncidentSecuriteModel>> readListIncidentSecuriteByOnline() async {
    ...
    return result.map(((e) => IncidentSecuriteModel.fromDBLocal(e))).toList();
  }
  ...
  saveIncidentSecurite(IncidentSecuriteModel model) async {
    return await dbHelper.insertIncidentSecurite(
        DBTable.incident_securite, model.dataMap());
  }

  saveIncidentSecuriteSync(IncidentSecuriteModel model) async {
    return await dbHelper.insertIncidentSecurite(
        DBTable.incident_securite, model.dataMapSync());
  }
  ...
  getIncidentSecuriteByNumero(numero) async {
    return await dbHelper.readIncidentSecuriteByNumero(
        DBTable.incident_securite, numero);
  }
  ...
  readChampObligatoireIncidentSecurite() async {
    return await dbHelper.readChampObligatoireIncidentSecurite(
        DBTable.champ_obligatoire_incident_securite);
  }

  saveChampObligatoireIncidentSecurite(
      ChampObligatoireIncidentSecuriteModel model) async {
    return await dbHelper.insertChampObligatoireIncidentSecurite(
        DBTable.champ_obligatoire_incident_securite, model.dataMap());
  }
  ...
  savePosteTravail(PosteTravailModel model) async {
    return await dbHelper.insertPosteTravail(
        DBTable.poste_travail, model.dataMap());
  }
  ...
  readTypeIncidentSecurite() async {
    return await dbHelper
        .readTypeIncidentSecurite(DBTable.type_incident_securite);
  }

  saveTypeIncidentSecurite(TypeIncidentModel model) async {
    return await dbHelper.insertTypeIncidentSecurite(
        DBTable.type_incident_securite, model.dataMap());
  }
  ...
  readCategoryIncidentSecurite() async {
    return await dbHelper
        .readCategoryIncidentSecurite(DBTable.category_incident_securite);
  }

  saveCategoryIncidentSecurite(CategoryModel model) async {
    return await dbHelper.insertCategoryIncidentSecurite(
        DBTable.category_incident_securite, model.dataMap());
  }
  ...
  readTypeCauseIncidentSecurite() async {
    return await dbHelper
        .readTypeCauseIncidentSecurite(DBTable.type_cause_incident_securite);
  }
  ...
  saveTypeCauseIncidentSecurite(TypeCauseIncidentModel model) async {
    return await dbHelper.insertTypeCauseIncidentSecurite(
        DBTable.type_cause_incident_securite, model.dataMapIncidentEnv());
  }
  ...
  readTypeCauseIncSecRattacher(incident) async {
    return await dbHelper.readTypeCauseIncSecRattacher(
        DBTable.type_cause_incident_securite_rattacher, incident);
  }
  ...
  Future<List<TypeCauseIncidentModel>>
    ...
    final List result = response;
    return result
        .map(((e) => TypeCauseIncidentModel.fromDBLocalIncSec(e)))
        .toList();
  }

  saveTypeCauseIncSecRattacher(TypeCauseIncidentModel model) async {
    return await dbHelper.insertTypeCauseIncSecRattacher(
        DBTable.type_cause_incident_securite_rattacher,
        model.dataMapIncidentSecRattacher());
  }
  ...
  readTypeConsequenceIncidentSecurite() async {
    return await dbHelper.readTypeConsequenceIncidentSecurite(
        DBTable.type_consequence_incident_securite);
  }
  ...
  saveTypeConsequenceIncidentSecurite(TypeConsequenceModel model) async {
    return await dbHelper.insertTypeConsequenceIncidentSecurite(
        DBTable.type_consequence_incident_securite, model.dataMapIncidentEnv());
  }
  ...
  readTypeConsequenceIncSecRattacher(incident) async {
    return await dbHelper.readTypeConsequenceIncSecRattacher(
        DBTable.type_consequence_incident_securite_rattacher, incident);
  }

  Future<List<TypeConsequenceIncidentModel>>
      readTypeConsequenceIncSecRattacherByOnline() async {
    final response =
        await dbHelper.readTypeConsequenceIncSecRattacherByOnline();
    final List result = response;
    return result
        .map(((e) => TypeConsequenceIncidentModel.fromDBLocalIncSec(e)))
        .toList();
  }

  saveTypeConsequenceIncSecRattacher(TypeConsequenceIncidentModel model) async {
    return await dbHelper.insertTypeConsequenceIncSecRattacher(
        DBTable.type_consequence_incident_securite_rattacher,
        model.dataMapIncSecRattacher());
  }
  ...
  readCauseTypiqueIncidentSecurite() async {
    return await dbHelper.readCauseTypiqueIncidentSecurite(
        DBTable.cause_typique_incident_securite);
  }
  ...
  saveCauseTypiqueIncidentSecurite(CauseTypiqueModel model) async {
    return await dbHelper.insertCauseTypiqueIncidentSecurite(
        DBTable.cause_typique_incident_securite,
        model.dataMapIncSecARattacher());
  }
  ...
  Future<List<CauseTypiqueModel>>
      readCauseTypiqueIncSecRattacherByOnline() async {
    final response = await dbHelper.readCauseTypiqueIncSecRattacherByOnline();
    final List result = response;
    return result.map(((e) => CauseTypiqueModel.fromDBLocal(e))).toList();
  }

  readCauseTypiqueIncSecRattacher(incident) async {
    return await dbHelper.readCauseTypiqueIncSecRattacher(
        DBTable.cause_typique_incident_securite_rattacher, incident);
  }

  saveCauseTypiqueIncSecRattacher(CauseTypiqueModel model) async {
    return await dbHelper.insertCauseTypiqueIncSecRattacher(
        DBTable.cause_typique_incident_securite_rattacher,
        model.dataMapIncSecRattacher());
  }
  ...
  readSiteLesionIncidentSecurite() async {
    return await dbHelper
        .readSiteLesionIncidentSecurite(DBTable.site_lesion_incident_securite);
  }
  ...
  saveSiteLesionIncidentSecurite(SiteLesionModel model) async {
    return await dbHelper.insertSiteLesionIncidentSecurite(
        DBTable.site_lesion_incident_securite,
        model.dataMapSiteLesionARattacher());
  }
  ...
  readSiteLesionIncSecRattacher(incident) async {
    return await dbHelper.readSiteLesionIncSecRattacher(
        DBTable.site_lesion_incident_securite_rattacher, incident);
  }
  ...
  Future<List<SiteLesionModel>> readSiteLesionIncSecRattacherByonline() async {
    ...
    return reslut.map((data) => SiteLesionModel.fromDBLocal(data)).toList();
  }

  saveSiteLesionIncSecRattacher(SiteLesionModel model) async {
    return await dbHelper.insertSiteLesionIncSecRattacher(
        DBTable.site_lesion_incident_securite_rattacher,
        model.dataMapSiteLesionRattacher());
  }
  ...
  readGraviteIncidentSecurite() async {
    return await dbHelper
        .readGraviteIncidentSecurite(DBTable.gravite_incident_securite);
  }

  saveGraviteIncidentSecurite(GraviteModel model) async {
    return await dbHelper.insertGraviteIncidentSecurite(
        DBTable.gravite_incident_securite, model.dataMap());
  }
  ...
  readSecteurIncidentSecurite() async {
    return await dbHelper
        .readSecteurIncidentSecurite(DBTable.secteur_incident_securite);
  }

  saveSecteurIncidentSecurite(SecteurModel model) async {
    return await dbHelper.insertSecteurIncidentSecurite(
        DBTable.secteur_incident_securite, model.dataMapIncidentEnv());
  }
  ...
  readCoutEstimeIncidentSecurite() async {
    return await dbHelper
        .readCoutEstimeIncidentSecurite(DBTable.cout_estime_incident_securite);
  }

  saveCoutEstimeIncidentSecurite(CoutEstimeIncidentEnvModel model) async {
    return await dbHelper.insertCoutEstimeIncidentSecurite(
        DBTable.cout_estime_incident_securite, model.dataMap());
  }
  ...
  readEvenementDeclencheurIncidentSecurite() async {
    return await dbHelper.readEvenementDeclencheurIncidentSecurite(
        DBTable.evenement_declencheur_incident_securite);
  }

  saveEvenementDeclencheurIncidentSecurite(
      EvenementDeclencheurModel model) async {
    return await dbHelper.insertEvenementDeclencheurIncidentSecurite(
        DBTable.evenement_declencheur_incident_securite, model.dataMap());
  }
  ...
  readIncidentSecuriteDecisionTraitement() async {
    return await dbHelper.readIncidentSecuriteDecisionTraitement(
        DBTable.incident_securite_decision_traitement);
  }

  saveIncidentSecuriteDecisionTraitement(
      IncidentSecuriteAgendaModel model) async {
    return await dbHelper.insertIncidentSecuriteDecisionTraitement(
        DBTable.incident_securite_decision_traitement, model.dataMap());
  }
  ...
  readIncidentSecuriteATraiter() async {
    return await dbHelper
        .readIncidentSecuriteATraiter(DBTable.incident_securite_a_traiter);
  }

  saveIncidentSecuriteATraiter(IncidentSecuriteAgendaModel model) async {
    return await dbHelper.insertIncidentSecuriteATraiter(
        DBTable.incident_securite_a_traiter, model.dataMap());
  }
  ...
  readIncidentSecuriteACloturer() async {
    return await dbHelper
        .readIncidentSecuriteACloturer(DBTable.incident_securite_a_cloturer);
  }

  saveIncidentSecuriteACloturer(IncidentSecuriteAgendaModel model) async {
    return await dbHelper.insertIncidentSecuriteACloturer(
        DBTable.incident_securite_a_cloturer, model.dataMap());
  }
  ...
  //action inc sec rattacher
  readActionIncSecRattacherByidFiche(idFiche) async {
    return await dbHelper.readActionIncSecRattacherByidFiche(idFiche);
  }

  Future<List<ActionIncSec>> readActionSecEnvRattacherByOnline() async {
    final response = await dbHelper.readActionIncSecRattacherByOnline();
    final List result = response;
    return result.map((e) => ActionIncSec.fromSQLite(e)).toList();
  }

  saveActionIncSecRattacher(ActionIncSec model) async {
    return await dbHelper.insertActionIncSecRattacher(
        DBTable.action_inc_sec_rattacher, model.toSQLite());
  }

  deleteTableActionIncSecRattacher() async {
    debugPrint('delete Table ActionIncSecRattacher');
    return await dbHelper.deleteTableActionIncSecRattacher();
  }

  readActionIncSecARattacher(idFiche) async {
    return await dbHelper.readActionIncSecARattacher(idFiche);
  }
}
