...
class LocalActionService {
  ...
  saveDomaineAffectation(DomaineAffectationModel model) async {
    return await dbHelper.insertDomaineAffectation(DBTable.domaine_affectation, model.dataMap());
  }
  ...
  saveChampCache(ChampCacheModel model) async {
    return await dbHelper.insertChampCache(DBTable.champ_cache, model.dataMap());
  }
  ...
  readChampObligatoireAction() async {
    return await dbHelper.readChampObligatoireAction(DBTable.champ_obligatoire_action);
  }
  saveChampObligatoireAction(ChampObligatoireActionModel model) async {
    return await dbHelper.insertChampObligatoireAction(DBTable.champ_obligatoire_action, model.dataMap());
  }
  ...
  saveSourceAction(SourceActionModel model) async {
    return await dbHelper.insertSourceAction(DBTable.source_action, model.dataMap());
  }
  ...
  saveTypeAction(TypeActionModel model) async {
    return await dbHelper.insertTypeAction(DBTable.type_action, model.dataMap());
  }
  ...
  Future<List<TypeCauseModel>> readTypeCauseActionOffline() async {
    ...
    return result.map((
            (e) => TypeCauseModel.fromDBLocal(e)
    )).toList();
  }
  ...
  saveTypeCauseAction(TypeCauseModel model) async {
    return await dbHelper.insertTypeCauseAction(DBTable.type_cause_action, model.dataMapAction());
  }
  ...
  readTypeCauseActionARattacher() async {
    return await dbHelper.readTypeCauseActionARattacher(DBTable.type_cause_action_a_rattacher);
  }
  ...
  saveTypeCauseActionARattacher(TypeCauseModel model) async {
    return await dbHelper.insertTypeCauseActionARattacher(DBTable.type_cause_action_a_rattacher, model.dataMapActionARattacher());
  }
  ...
  saveResponsableCloture(RespClotureModel model) async {
    return await dbHelper.insertResponsableCloture(DBTable.resp_cloture, model.dataMap());
  }
  ...
  saveProcessusEmploye(ProcessusEmployeModel model) async {
    return await dbHelper.insertProcessusEmploye(DBTable.processus_employe, model.dataMap());
  }
  ...
  readServiceByModuleAndDirection(module, fiche, codeDirection) async {
    return await dbHelper.readServiceByModuleAndDirection(module, fiche, codeDirection);
  }
  ...
  deleteAllEmploye() async {
    await dbHelper.deleteAllEmploye();
  ...
  saveAuditAction(AuditActionModel model) async {
    return await dbHelper.insertAuditAction(DBTable.audit_action, model.dataMap());
  }
 ...
 //action
  ...
  saveActionSync(ActionSync action) async {
    return await dbHelper.insertActionSync(DBTable.action_sync, action.dataMap());
  }
  ...
  Future<List<SousActionModel>> readListSousActionByOnline() async {
    ...
    final List result = response;
    return result.map((
            (e) => SousActionModel.fromDBLocal(e)
    )).toList();
  }
  ...
  saveSousAction(SousActionModel model) async {
    return await dbHelper.insertSousAction(DBTable.sous_action, model.dataMap());
  }
  ...
  saveActionRealisation(ActionRealisationModel model) async {
    return await dbHelper.insertActionRealisation(DBTable.action_realisation, model.dataMap());
  }
  ...
  saveActionSuivi(ActionSuiviModel model) async {
    return await dbHelper.insertActionSuivi(DBTable.action_suivi, model.dataMap());
  }
  ...
  saveActionSuiteAudit(ActionSuiteAudit model) async {
    return await dbHelper.insertActionSuiteAudit(DBTable.action_suite_audit, model.dataMap());
  }
