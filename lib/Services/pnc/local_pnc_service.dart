...
class LocalPNCService {
  ...
  readChampObligatoirePNC() async {
    return await dbHelper
        .readChampObligatoirePNC(DBTable.champ_obligatoire_pnc);
  }

  saveChampObligatoirePNC(ChampObligatoirePNCModel model) async {
    return await dbHelper.insertChampObligatoirePNC(
        DBTable.champ_obligatoire_pnc, model.dataMap());
  }
  ...
  saveFournisseur(FournisseurModel model) async {
    return await dbHelper.insertFournisseur(
        DBTable.fournisseur, model.dataMap());
  }
  ...
  saveGravitePNC(GravitePNCModel model) async {
    return await dbHelper.insertGravitePNC(
        DBTable.gravite_pnc, model.dataMap());
  }
  ...
  saveAtelierPNC(AtelierPNCModel model) async {
    return await dbHelper.insertAtelierPNC(
        DBTable.atelier_pnc, model.dataMap());
  }
  ...
  Future<List<PNCModel>> readListPNCByOnline() async {
    ...
    return result.map(((e) => PNCModel.fromDBLocal(e))).toList();
  }
  ...
  Future<List<ProductPNCModel>> readListProductPNCByOnline() async {
    ...
    final List result = response;
    return result.map(((e) => ProductPNCModel.fromDBLocal(e))).toList();
  }

  saveProductPNC(ProductPNCModel model) async {
    return await dbHelper.insertProductPNC(
        DBTable.product_pnc, model.dataMap());
  }
  ...
  Future<List<TypeCausePNCModel>> readListTypeCausePNCByOnline() async {
    ...
    final List result = response;
    return result.map(((e) => TypeCausePNCModel.fromDBLocal(e))).toList();
  }

  saveTypeCausePNC(TypeCausePNCModel model) async {
    return await dbHelper.insertTypeCausePNC(
        DBTable.type_cause_pnc, model.dataMap());
  }
  ...
  readAllTypeCausePNCARattacher() async {
    return await dbHelper
        .readAllTypeCausePNCARattacher(DBTable.type_cause_a_rattacher_pnc);
  }
  ...
  saveTypeCausePNCARattacher(TypeCausePNCModel model) async {
    return await dbHelper.insertTypeCausePNCARattacher(
        DBTable.type_cause_a_rattacher_pnc, model.dataMapARattacher());
  }
  ...
  readTypeProductNNC(int? nnc, int? idProduct) async {
    return await dbHelper.readTypeProductNNC(nnc, idProduct);
  }

  Future<List<TypePNCModel>> readTypeProductNNCByOnline() async {
    final response = await dbHelper.readTypeProductNNCByOnline();
    final List result = response;
    return result.map(((model) => TypePNCModel.fromDBLocal(model))).toList();
  }

  saveTypeProductPNC(TypePNCModel model) async {
    return await dbHelper.insertTypeProductNNC(
        DBTable.type_product_pnc, model.dataMapTypeProductNC());
  }

  deleteTableTypeProductNNC() async {
    return await dbHelper.deleteTableTypeProductNNC();
  }

  readTypeProductPNCARattacher(idProduct) async {
    return await dbHelper.readTypeProductPNCARattacher(idProduct);
  }

  getMaxIdTypeProductPNC() async {
    return await dbHelper.getMaxIdTypeProductPNC();
  }

  //upload image
  Future<List<UploadImageModel>> readImagesPNC() async {
    final response = await dbHelper.readImagesPNC();
    final List result = response;
    return result.map(((e) => UploadImageModel.fromDBLocal(e))).toList();
  }

  uploadImagePNC(UploadImageModel model) async {
    return await dbHelper.uploadImagePNC(
        DBTable.upload_image_pnc, model.dataMap());
  }

  deleteTableImagePNC() async {
    return await dbHelper.deleteTableImagePNC();
  }
  ...
  savePNCValider(PNCCorrigerModel model) async {
    return await dbHelper.insertPNCValider(
        DBTable.pnc_valider, model.dataMapPNCValider());
  }
  ...
  savePNCACorriger(PNCCorrigerModel model) async {
    return await dbHelper.insertPNCACorriger(
        DBTable.pnc_corriger, model.dataMapPNCCorriger());
  }
  ...
  readPNCInvestigationEffectuer() async {
    return await dbHelper
        .readPNCInvestigationEffectuer(DBTable.pnc_investigation_effectuer);
  }

  savePNCInvestigationEffectuer(PNCSuivreModel model) async {
    return await dbHelper.insertPNCInvestigationEffectuer(
        DBTable.pnc_investigation_effectuer,
        model.dataMapPNCInvestigationEffectuer());
  }
  ...
  readPNCInvestigationApprouver() async {
    return await dbHelper
        .readPNCInvestigationApprouver(DBTable.pnc_investigation_approuver);
  }

  savePNCInvestigationApprouver(PNCSuivreModel model) async {
    return await dbHelper.insertPNCInvestigationApprouver(
        DBTable.pnc_investigation_approuver,
        model.dataMapPNCInvestigationApprouver());
  }
  ...
  savePNCDecision(TraitementDecisionModel model) async {
    return await dbHelper.insertPNCDecision(
        DBTable.pnc_decision, model.dataMapPNCDecision());
  }
  ...
  savePNCATraiter(PNCTraiterModel model) async {
    return await dbHelper.insertPNCATraiter(
        DBTable.pnc_traiter, model.dataMapPNCATraiter());
  }
  ...
  savePNCASuivre(PNCSuivreModel model) async {
    return await dbHelper.insertPNCASuivre(
        DBTable.pnc_suivre, model.dataMapPNCSuivre());
  }
  ...
  readPNCApprobationFinale() async {
    return await dbHelper
        .readPNCApprobationFinale(DBTable.pnc_approbation_finale);
  }

  savePNCApprobationFinale(PNCSuivreModel model) async {
    return await dbHelper.insertPNCApprobationFinale(
        DBTable.pnc_approbation_finale, model.dataMapPNCApprobationFinale());
  }
  ...
  readPNCDecisionValidation() async {
    return await dbHelper
        .readPNCDecisionValidation(DBTable.pnc_decision_validation);
  }

  savePNCDecisionValidation(PNCValidationTraitementModel model) async {
    return await dbHelper.insertPNCDecisionValidation(
        DBTable.pnc_decision_validation, model.dataMap());
  }
