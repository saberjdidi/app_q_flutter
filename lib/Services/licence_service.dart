...
class LicenceService {
  ...
  saveLicenceInfo(LicenceModel model) async {
    return await dbHelper.insertLicenceInfo(DBTable.licence_info, model.dataMap());
  }
  deleteTableLicenceInfo() async {
    await dbHelper.deleteTableLicenceInfo();
  ...
  saveBeginLicence(BeginLicenceModel model) async {
    return await dbHelper.insertBeginLicence(DBTable.mobile_licence, model.dataMap());
  }
