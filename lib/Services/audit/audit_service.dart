...
class AuditService {
  ...
  Future<List<AuditModel>> getAudits() async {
    try {
      ...
      if (response.statusCode == 200) {
        final List result =
            jsonDecode(response.body); //jsonDecode(response.body)['data'];
        return result.map(((e) => AuditModel.fromJson(e))).toList();
      } else {
  ...
  Future<List<AuditModel>> searchAudit(idAudit, etat, type) async {
    try {
      if (kDebugMode) {
        print(Uri.parse(
            '${AppConstants.AUDIT_URL}/GetListAudit?mat=$matricule&idAudit=$idAudit&etat=$etat&typeA=$type'));
      }
      Response response = await get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/GetListAudit?mat=$matricule&idAudit=$idAudit&etat=$etat&typeA=$type'),
  ...
  Future<List<dynamic>> getConstatAudit(refAudit, mode) async {
    try {
      if (kDebugMode)
        print(Uri.parse(
            '${AppConstants.AUDIT_URL}/GetListConstat?RefAudit=$refAudit&Mode=$mode'));
  ...
  Future<dynamic> deleteConstatAudit(idEcart, nAct, refAudit) async {
    try {
      print(
          '${AppConstants.AUDIT_URL}/deleteConstatAudit?idEcart=$idEcart&nAct=$nAct&refAudit=$refAudit');
  ...
  Future<List<dynamic>> getChampAuditByFiche(refAudit) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListChampsAuditAjoutes?RefAudit=$refAudit'),
          headers: {'Content-Type': 'application/json'});
      //print('response ${jsonDecode(response.body)}');
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getPersonConstatAudit(refAudit, matricule) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/PersonneConcerneeConstat?RefAudit=$refAudit&Mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getAuditeurInterne(refAudit) async {
    try {
      if (kDebugMode)
        print(Uri.parse(
            '${AppConstants.AUDIT_URL}/ListeAuditeursInternes?Ref=$refAudit'));
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListeAuditeursInternes?Ref=$refAudit'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getAuditeurInterneToAdd(refAudit) async {
    try {
      if (kDebugMode)
        print(Uri.parse(
            '${AppConstants.AUDIT_URL}/ListeAuditeursInternes_aAjoutes?Ref=$refAudit'));
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListeAuditeursInternes_aAjoutes?Ref=$refAudit'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<dynamic> deleteAutideurInterne(matricule, refAudit) async {
    try {
      print(
          '${AppConstants.AUDIT_URL}/DeleteAuditeurInterne?Mat=$matricule&RefAudit=$refAudit');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/DeleteAuditeurInterne?Mat=$matricule&RefAudit=$refAudit'),
          headers: {'Content-Type': 'application/json'});
  ...
  //auditeur externe
  Future<List<dynamic>> getAllAuditeursExterne() async {
    try {
      debugPrint('${AppConstants.AUDIT_URL}/listAllAuditeursExternes');
      var response = await http.get(
          Uri.parse('${AppConstants.AUDIT_URL}/listAllAuditeursExternes'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
      } else {
      ...
      return Future.error(
          'Service Auditeurs Externe : ${Exception.toString()}');
    }
  }

  Future<List<dynamic>> getAuditeurExterne(refAudit, lang) async {
    try {
      if (kDebugMode)
        print(Uri.parse(
            '${AppConstants.AUDIT_URL}/ListeAuditeursExternes?refAudit=$refAudit&lang=$lang'));
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListeAuditeursExternes?refAudit=$refAudit&lang=$lang'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getAuditeurExterneToAdd(refAudit) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListeAuditeursExternesaAjoutes?Ref=$refAudit'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
      } else {
  ...
  Future<dynamic> deleteAuditeurExterne(code, refAudit) async {
    try {
      if (kDebugMode)
        print(
            '${AppConstants.AUDIT_URL}/DeleteAuditeurExterne?CodeAuditeur=$code&RefAudit=$refAudit');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/DeleteAuditeurExterne?CodeAuditeur=$code&RefAudit=$refAudit'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getEmployeHabiliteAudit(refAudit) async {
    try {
      if (kDebugMode)
        print(Uri.parse(
            '${AppConstants.AUDIT_URL}/listEmployeHabiliteAudit?refAudit=$refAudit'));
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/listEmployeHabiliteAudit?refAudit=$refAudit'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<dynamic> addEmployeHabiliteAudit(Map data) async {
    try {
      ...
      return Future.error(
          'service add employe habilte : ${exception.toString()}');
    }
  }
  ...
  Future<dynamic> deleteEmployeHabiliteAudit(refAudit, mat) async {
    try {
      if (kDebugMode)
        print(
            '${AppConstants.AUDIT_URL}/deleteEmployeHabiliteAudit?refAudit=$refAudit&mat=$mat');
      var response = await http.delete(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/deleteEmployeHabiliteAudit?refAudit=$refAudit&mat=$mat'),
          headers: {'Content-Type': 'application/json'});
  ...
  //checklist
  Future<List<dynamic>> getCheckListByRefAudit(refAudit, online) async {
    try {
      if (kDebugMode)
        print(
            '${AppConstants.AUDIT_URL}/checkList?refAudit=$refAudit&online=$online');
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/checkList?refAudit=$refAudit&online=$online'),
          headers: {'Content-Type': 'application/json'});
  ...
  Future<List<dynamic>> getCritereOfCheckList(refAudit, idChamp, online) async {
    try {
      var response = await http.get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/critereOfCheckList?refAudit=$refAudit&idChamp=$idChamp&online=$online'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
      } else {
      ...
      return Future.error(
          'service critere checklist audit : ${exception.toString()}');
    }
  }
  ...
  Future<List<dynamic>> getAuditsEnTantQueAudite() async {
    try {
      Response response = await get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListeAuditEnTantQueAudite?Mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getConfirmAuditAudite(refAudit, mode) async {
    try {
      Response response = await get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/confirmAuditAudite?refAudit=$refAudit&mat=$matricule&mode=$mode'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
  ...
  Future<dynamic> confirmeAuditEnTantqueAudite(Map data) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ValiderListeAuditEnTantQueAudite'),
          body: json.encode(data),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getAuditsEnTantQueAuditeur() async {
    try {
      Response response = await get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ListeAuditEnTantQueAuditeur?Mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
  ...
  Future<dynamic> confirmeAuditEnTantqueAuditeur(Map data) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/ValiderListeAuditEnTantQueAuditeur'),
          body: json.encode(data),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
  ...
  Future<List<dynamic>> getRapportAuditsAValider() async {
    try {
      Response response = await get(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/RapportAuditA_Valider?Mat=$matricule'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
  ...
  Future<dynamic> validerRapportAudit(refAudit) async {
    try {
      var response = await http.put(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/validerRapportAudit?RefAudit=$refAudit'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
      } else {
  ...
  Future<dynamic> envoyerRapportAudit(refAudit) async {
    try {
      var response = await http.put(
          Uri.parse(
              '${AppConstants.AUDIT_URL}/envoyerRapportAudit?RefAudit=$refAudit'),
          headers: {'Content-Type': 'application/json'});
      if (response.statusCode == 200) {
        return await jsonDecode(response.body);
      } else {
