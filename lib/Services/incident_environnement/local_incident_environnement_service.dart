...
class LocalIncidentEnvironnementService {
  ...
  searchIncidentEnvironnement(numero, type, designation) async {
    return await dbHelper.searchIncidentEnvironnement(numero, type, designation);
  }
  ...
  Future<List<IncidentEnvModel>> readListIncidentEnvironnementByOnline() async {
    ...
    return result.map((
            (e) => IncidentEnvModel.fromDBLocal(e)
    )).toList();
  }
  ...
  saveIncidentEnvironnement(IncidentEnvModel model) async {
    return await dbHelper.insertIncidentEnvironnement(DBTable.incident_environnement, model.dataMap());
  }
  saveIncidentEnvironnementSync(IncidentEnvModel model) async {
    return await dbHelper.insertIncidentEnvironnement(DBTable.incident_environnement, model.dataMapSync());
  }
  ...
  getIncidentEnvironnementByNumero(numero) async {
    return await dbHelper.readIncidentEnvironnementByNumero(DBTable.incident_environnement,numero);
  }
  ...
  readChampObligatoireIncidentEnv() async {
    return await dbHelper.readChampObligatoireIncidentEnv(DBTable.champ_obligatoire_incident_env);
  }
  saveChampObligatoireIncidentEnv(ChampObligatoireIncidentEnvModel model) async {
    return await dbHelper.insertChampObligatoireIncidentEnv(DBTable.champ_obligatoire_incident_env, model.dataMap());
  }
  ...
  readTypeCauseIncidentEnv() async {
    return await dbHelper.readTypeCauseIncidentEnv(DBTable.type_cause_incident_env);
  }
  ...
  saveTypeCauseIncidentEnv(TypeCauseIncidentModel model) async {
    return await dbHelper.insertTypeCauseIncidentEnv(DBTable.type_cause_incident_env, model.dataMapIncidentEnv());
  }
  ...
  readTypeCauseRattacherEnvByIncident(incident) async {
    return await dbHelper.readTypeCauseRattacherEnvByIncident(DBTable.type_cause_incident_env_rattacher, incident);
  }
  Future<List<TypeCauseIncidentModel>> readTypeCauseIncidentEnvRattacherByOnline() async {
    final response =  await dbHelper.readTypeCauseIncidentEnvRattacherByOnline();
    final List result = response;
    return result.map((
            (e) => TypeCauseIncidentModel.fromDBLocalIncEnv(e)
    )).toList();
  }
  saveTypeCauseRattacherIncidentEnv(TypeCauseIncidentModel model) async {
    return await dbHelper.insertTypeCauseRattacherIncidentEnv(DBTable.type_cause_incident_env_rattacher, model.dataMapIncidentEnvRattacher());
  }
  ...
  readCategoryIncidentEnv() async {
    return await dbHelper.readCategoryIncidentEnv(DBTable.category_incident_env);
  }
  saveCategoryIncidentEnv(CategoryModel model) async {
    return await dbHelper.insertCategoryIncidentEnv(DBTable.category_incident_env, model.dataMap());
  }
 ...
 //Type Consequence
  readTypeConsequenceIncidentEnv() async {
    return await dbHelper.readTypeConsequenceIncidentEnv(DBTable.type_consequence_incident_env);
  }
  ...
  saveTypeConsequenceIncidentEnv(TypeConsequenceIncidentModel model) async {
    return await dbHelper.insertTypeConsequenceIncidentEnv(DBTable.type_consequence_incident_env, model.dataMapIncidentEnv());
  }
  ...
  readTypeConsequenceRattacherEnvByIncident(incident) async {
    return await dbHelper.readTypeConsequenceRattacherEnvByIncident(DBTable.type_consequence_incident_env_rattacher, incident);
  }
  Future<List<TypeConsequenceIncidentModel>> readTypeConsequenceIncidentEnvRattacherByOnline() async {
    final response =  await dbHelper.readTypeConsequenceIncidentEnvRattacherByOnline();
    final List result = response;
    return result.map((
            (e) => TypeConsequenceIncidentModel.fromDBLocalIncEnv(e)
    )).toList();
  }
  saveTypeConsequenceRattacherIncidentEnv(TypeConsequenceIncidentModel model) async {
    return await dbHelper.insertTypeConsequenceRattacherIncidentEnv(DBTable.type_consequence_incident_env_rattacher, model.dataMapIncidentEnvRattacher());
  }
  ...
  getMaxNumTypeConsequenceIncidentEnvironnementRattacher() async {
    return await dbHelper.getMaxNumTypeConsequenceIncidentEnvironnementRattacher();
  }
  //Type
  ...
  saveTypeIncidentEnv(TypeIncidentModel model) async {
    return await dbHelper.insertTypeIncidentEnv(DBTable.type_incident_env, model.dataMap());
  }
  ...
  saveLieuIncidentEnv(LieuModel model) async {
    return await dbHelper.insertLieuIncidentEnv(DBTable.lieu_incident_env, model.dataMapIncidentEnv());
  }
  ...
  saveSourceIncidentEnv(SourceIncidentEnvModel model) async {
    return await dbHelper.insertSourceIncidentEnv(DBTable.source_incident_env, model.dataMap());
  }
  ...
  readCoutEstimeIncidentEnv() async {
    return await dbHelper.readCoutEstimeIncidentEnv(DBTable.cout_estime_incident_env);
  }
  saveCoutEstimeIncidentEnv(CoutEstimeIncidentEnvModel model) async {
    return await dbHelper.insertCoutEstimeIncidentEnv(DBTable.cout_estime_incident_env, model.dataMap());
  }
  ...
  saveGraviteIncidentEnv(GraviteModel model) async {
    return await dbHelper.insertGraviteIncidentEnv(DBTable.gravite_incident_env, model.dataMap());
  }
 ...
 //secteur
  ...
  saveSecteurIncidentEnv(SecteurModel model) async {
    return await dbHelper.insertSecteurIncidentEnv(DBTable.secteur_incident_env, model.dataMapIncidentEnv());
  }
  ...
  readIncidentEnvDecisionTraitement() async {
    return await dbHelper.readIncidentEnvDecisionTraitement(DBTable.incident_env_decision_traitement);
  }
  saveIncidentEnvDecisionTraitement(IncidentEnvAgendaModel model) async {
    return await dbHelper.insertIncidentEnvDecisionTraitement(DBTable.incident_env_decision_traitement, model.dataMap());
  }
  ...
  readIncidentEnvATraiter() async {
    return await dbHelper.readIncidentEnvATraiter(DBTable.incident_env_a_traiter);
  }
  saveIncidentEnvATraiter(IncidentEnvAgendaModel model) async {
    return await dbHelper.insertIncidentEnvATraiter(DBTable.incident_env_a_traiter, model.dataMap());
  }
  ...
  readIncidentEnvACloturer() async {
    return await dbHelper.readIncidentEnvACloturer(DBTable.incident_env_a_cloturer);
  }
  saveIncidentEnvACloturer(IncidentEnvAgendaModel model) async {
    return await dbHelper.insertIncidentEnvACloturer(DBTable.incident_env_a_cloturer, model.dataMap());
  }
