...
class ImagePNC extends StatefulWidget {
  final numFiche;
  const ImagePNC({Key? key, required this.numFiche}) : super(key: key);

  @override
  State<ImagePNC> createState() => _ImagePNCState();
}

class _ImagePNCState extends State<ImagePNC> {
  ...
  getData() async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        await PNCService().getImagePNC(widget.numFiche).then((response) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Images P.N.C N°${widget.numFiche}',
