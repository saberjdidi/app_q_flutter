...
class NewTypeCauseIncidentSecurite extends StatefulWidget {
  ...
  const NewTypeCauseIncidentSecurite({Key? key, required this.numIncident})
      : super(key: key);

  @override
  State<NewTypeCauseIncidentSecurite> createState() =>
      _NewTypeCauseIncidentSecuriteState();
}

class _NewTypeCauseIncidentSecuriteState
    extends State<NewTypeCauseIncidentSecurite> {
                        ...
                        Visibility(
                            ...
                            child: DropdownSearch<TypeCauseIncidentModel>(
                              ...
                              onChanged: (data) {
                                ...
                                debugPrint(
                                    'type cause: ${typeCause}, code: ${selectedCodeType}');
                              },
    ...
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        var response = await LocalIncidentSecuriteService()
            .readTypeCauseIncSecARattacher(widget.numIncident);
        ...
        await IncidentSecuriteService()
            .getTypeCauseIncSecARattacher(widget.numIncident, matricule)
            .then((resp) async {
  ...
  Widget _customDropDownTypeCause(
      BuildContext context, TypeCauseIncidentModel? item) {
    if (item == null) {
      return Container();
    } else {
      return Container(
