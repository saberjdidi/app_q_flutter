                 ...
                 // return Text('${controller.listIncident[index].designation}');
                   return Container(
                        ...
                        child: Slidable(
                          ...
                          child: IncidentSecuriteWidget(model: controller.listIncident[index]),
                                        ...
                                        builder: (context, scrollController) => SingleChildScrollView(
                                          child: ListBody(
                                            children: <Widget>[
                                              SizedBox(height: 5.0,),
                                              Center(
                                                child: Text('Incident Securite N°${controller.listIncident[index].ref}', style: TextStyle(
                                                ...
                                                children: [
                                                  ...
                                                  ConstrainedBox(
                                                    ...
                                                    child: ElevatedButton.icon(
                                                      ...
                                                      onPressed: () {
                                                        Get.to(TypeCauseIncidentSecuritePage(numIncident: controller.listIncident[index].ref));
                                                      },
                                                    ),
                                                  ),
                                                  SizedBox(height: 10,),
                                                  ...
                                                  ConstrainedBox(
                                                    ...
                                                    child: ElevatedButton.icon(
                                                      ...
                                                      onPressed: () {
                                                        Get.to(TypeConsequenceIncidentSecuritePage(numIncident: controller.listIncident[index].ref));
                                                      },
                                                    ),
                                                  ),
                                                  SizedBox(height: 10,),
                                                  ConstrainedBox(
                                                    ...
                                                    child: ElevatedButton.icon(
                                                      style: ButtonStyle(
                                                        ...
                                                        backgroundColor:
                                                        MaterialStateProperty.all(Color(0xFF186D09)),
                                                        padding: MaterialStateProperty.all(EdgeInsets.all(14)),
                                                      ),
                          ...
                          endActionPane: ActionPane(
                            ...
                            children: [
                              SlidableAction(
                                ...
                                flex: 2,
                                onPressed: (context) {
                                  Get.to(ActionIncidentSecuritePage(numFiche: controller.listIncident[index].ref));
                                },
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          SpeedDialChild(
              ...
              onTap: (){
                Get.to(()=>NewIncidentSecuritePage(), transition: Transition.zoom, duration: Duration(milliseconds: 500));
              }
          ),
          SpeedDialChild(
              labelBackgroundColor: Colors.white,
                    ...
                    return AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            Get.find<IncidentSecuriteController>().listIncident.clear();
                            Get.find<IncidentSecuriteController>().searchIncident();
                            Get.back();
                          },
                          style: ButtonStyle(
