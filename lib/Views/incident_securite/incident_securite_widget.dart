...
class IncidentSecuriteWidget extends StatelessWidget {
  ...
  const IncidentSecuriteWidget({Key? key, required this.model}) : super(key: key);
              ...
              child: ListTile(
                title:  Row(
                  children: [
                    Expanded(
                      flex: 2,
                      child: Text("Reference ${model.ref} ${model.online == 1 ?'' :'*'}",
                        style: TextStyle(
                ...
                subtitle: Column(
                  ...
                  /*  Text("${model.nc}", style:
                    ...
                    ? Text('')
                    : Padding(
                      padding: (model.site=='' || model.site==null) ? const EdgeInsets.only(top: 0) : const EdgeInsets.only(top: 5.0),
                    ...
                    (model.gravite=='' || model.gravite==null)
                        ? Text('')
                        : Padding(
                      padding:(model.gravite=='' || model.gravite==null) ? const EdgeInsets.only(top: 0) : const EdgeInsets.only(top: 5.0),
                      child: Text("Gravite : ${model.gravite}",
                          style: TextStyle(
                              color: Color(0xFF3B465E),
                              fontWeight: FontWeight.w500)),
                    ),
                    (model.categorie=='' || model.categorie==null)
                        ? Text('')
                        : Padding(
                      padding: (model.categorie=='' || model.categorie==null) ? const EdgeInsets.only(top: 0) : const EdgeInsets.only(top: 5.0),
                      child: Text("Categorie : ${model.categorie}",
                          style: TextStyle(
                              color: Color(0xFF3B465E),
                              fontWeight: FontWeight.w500)),
                    ),
