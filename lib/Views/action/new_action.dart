                    ...
                    child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Visibility(
                              visible: controller.date_saisie_visible == 1
                                  ? controller.isVisibileDateSaisie = true
                                  : controller.isVisibileDateSaisie = false,
                              child: TextFormField(
                                enabled: false,
                            ...
                            Visibility(
                                ...
                                child: DropdownSearch<TypeActionModel>(
                                  ...
                                  onChanged: (data) {
                                    controller.selectedCodeTypeAct =
                                        data?.codetypeAct;
                            ...
                            Visibility(
                                ...
                                child: DropdownSearch<SourceActionModel>(
                                  showSelectedItems: true,
                                  showClearButton:
                                      controller.sourceActionModel?.sourceAct ==
                                              ""
                                          ? false
                                          : true,
                                  showSearchBox: true,
                                  ...
                                  onFind: (String? filter) =>
                                      getSources(filter),
                                  onChanged: (data) {
                                    controller.selectedCodeSourceAct =
                                        data?.codeSouceAct;
                            ...
                            Visibility(
                                visible: controller.ref_audit_visible == 1
                                    ? controller.isVisibileRefAudit = true
                                    : controller.isVisibileRefAudit = false,
                                child: DropdownSearch<AuditActionModel>(
                                  showSelectedItems: true,
                                  showClearButton:
                                      controller.auditActionModel?.idaudit == ""
                                          ? false
                                          : true,
                                  showSearchBox: true,
                                  isFilteredOnline: true,
                                  ...
                                  onFind: (String? filter) =>
                                      getRefAudit(filter),
                                  onChanged: (data) {
                                    controller.selectedRefAuditAct =
                                        data?.refAudit;
                                  ...
                                  popupItemBuilder:
                                      controller.customPopupItemBuilderRefAudit,
                                )),
                            SizedBox(
                              height: 10.0,
                            ),
                            Visibility(
                                visible: controller.site_visible == 1
                                ...
                                child: DropdownSearch<SiteModel>(
                                    ...
                                    dropdownSearchDecoration: InputDecoration(
                                      labelText:
                                          "Site ${controller.site_obligatoire == 1 ? '*' : ''}",
                                      contentPadding:
                                          EdgeInsets.fromLTRB(12, 12, 0, 0),
                                      border: OutlineInputBorder(),
                                    ),
                                      ...
                                      if (b == null) {
                                        ...
                                        return showDialog<bool>(
                                            ...
                                            builder: (BuildContext context) {
                                              controller.selectedSiteCode = 0;
                                              print(
                                                  'clear site : ${controller.selectedSiteCode}');
                                              return alert;
                                            });
                                      }
                            ...
                            Visibility(
                                visible: controller.processus_visible == 1
                                ...
                                child: DropdownSearch<ProcessusModel>(
                                    ...
                                    dropdownSearchDecoration: InputDecoration(
                                      labelText:
                                          "Processus ${controller.processus_obligatoire == 1 ? '*' : ''}",
                                      contentPadding:
                                          EdgeInsets.fromLTRB(12, 12, 0, 0),
                                      border: OutlineInputBorder(),
                                    ),
                            ...
                            Visibility(
                                ...
                                child: DropdownSearch<RespClotureModel>(
                                    showSelectedItems: true,
                                    showClearButton:
                                        controller.respClotureModel?.nompre ==
                                                ""
                                            ? false
                                            : true,
                                    showSearchBox: true,
                            ...
                            Visibility(
                                visible: controller.origine_action_visible == 1
                                    ? controller.isVisibileOrigineAction = true
                                    : controller.isVisibileOrigineAction =
                                        false,
                                child: DropdownSearch<EmployeModel>(
                                    showSelectedItems: true,
                                    showClearButton:
                                        controller.employeModel?.nompre == ""
                                            ? false
                                            : true,
                                    showSearchBox: true,
                                    isFilteredOnline: true,
                            ...
                            Visibility(
                                visible: controller.direction_visible == 1
                                ...
                                child: DropdownSearch<DirectionModel>(
                                    ...
                                    dropdownSearchDecoration: InputDecoration(
                                      labelText:
                                          "Direction ${controller.direction_obligatoire == 1 ? '*' : ''}",
                                      contentPadding:
                                          EdgeInsets.fromLTRB(12, 12, 0, 0),
                                      border: OutlineInputBorder(),
                                    ),
                                    onFind: (String? filter) =>
                                        getDirection(filter),
                                    onChanged: (data) {
                                      controller.selectedDirectionCode =
                                          data?.codeDirection;
                            ...
                            Visibility(
                                visible: controller.service_visible == 1
                                ...
                                child: DropdownSearch<ServiceModel>(
                                    ...
                                    dropdownSearchDecoration: InputDecoration(
                                      labelText:
                                          "Service ${controller.service_obligatoire == 1 ? '*' : ''}",
                                      contentPadding:
                                          EdgeInsets.fromLTRB(12, 12, 0, 0),
                                      border: OutlineInputBorder(),
                                    ),
                                    onFind: (String? filter) =>
                                        getService(filter),
                                    onChanged: (data) {
                                      controller.selectedServiceCode =
                                          data?.codeService;
                            ...
                            Visibility(
                                visible: controller.activity_visible == 1
                                ...
                                child: DropdownSearch<ActivityModel>(
                                    ...
                                    onFind: (String? filter) =>
                                        getActivity(filter),
                                    onChanged: (data) {
                                      controller.selectedActivityCode =
                                          data?.codeDomaine;
                                      ...
                                      print(
                                          'activity:${controller.activityModel?.domaine}, code activity:${controller.selectedActivityCode}');
                                    },
                                    dropdownBuilder:
                            ...
                            Visibility(
                              visible: controller.type_cause_visible == 1
                                  ? controller.isVisibileTypeCause = true
                                  : controller.isVisibileTypeCause = false,
                              child:
                                  DropdownSearch<TypeCauseModel>.multiSelection(
                                searchFieldProps: TextFieldProps(
                                  controller: _filterEditTextController,
                                  decoration: InputDecoration(
                                    suffixIcon: IconButton(
                                ...
                                onChanged: (data) {
                                  ...
                                  data.forEach((element) {
                                    ...
                                    listCodeTypeCause
                                        .add(element.codetypecause);
                                    controller.typeCauseList
                                        .addAll(listCodeTypeCause);
                                  });
                                },
...
//source action
    ...
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        var sites = await controller.localActionService
            .readSiteByModule("Action", "Action");
        sites.forEach((data) {
          var model = SiteModel();
  ...
  Future<List<ProcessusModel>> getProcessus(filter) async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var sites = await controller.localActionService
            .readProcessusByModule("Action", "Action");
        sites.forEach((data) {
    ...
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        var response = await controller.localActionService
            .readDirectionByModule("Action", "Action");
        response.forEach((data) {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        var response = await controller.localActionService
            .readServiceByModuleAndDirection(
                'Action', 'Action', controller.selectedDirectionCode);
        ...
        await ApiServicesCall()
            .getService(controller.matricule, controller.selectedDirectionCode,
                'Action', 'Action')
            .then((resp) async {
          resp.forEach((data) async {
  ...
  Future<List<ActivityModel>> getActivity(filter) async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var response = await controller.localActionService
            .readActivityByModule("Action", "Action");
        response.forEach((data) {
  ...
  Future<List<RespClotureModel>> getRespCloture(filter) async {
    try {
      if (controller.selectedSiteCode == null ||
          controller.selectedProcessusCode == null) {
      ...
      if (connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var response = await controller.localActionService
            .readResponsableClotureParams(
                controller.selectedSiteCode, controller.selectedProcessusCode);
  ...
  Future<List<TypeCauseModel>> getTypesCause(filter) async {
    try {
      List<TypeCauseModel> typeCauseList =
      ...
      if (connection == ConnectivityResult.none) {
        ...
        var response =
            await controller.localActionService.readTypeCauseActionARattacher();
        response.forEach((data) {
