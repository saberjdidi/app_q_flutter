...
class EquipeVisiteSecPage extends StatefulWidget {
 ...
 const EquipeVisiteSecPage({Key? key, required this.numFiche}) : super(key: key);
...
class _EquipeVisiteSecPageState extends State<EquipeVisiteSecPage> {
  ...
  List<EquipeVisiteSecuriteModel> listEquipe = List<EquipeVisiteSecuriteModel>.empty(growable: true);
  ...
  void getData() async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        var response = await LocalVisiteSecuriteService().readEquipeVisiteSecuriteOfflineByIdFiche(widget.numFiche);
        ...
        //rest api
        await VisiteSecuriteService().getEquipeVisiteSecurite(widget.numFiche).then((response) async {
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: InkWell(
                            onTap: () async{
                             /* var connectionInternet = Connectivity().checkConnectivity();
                              if(connectionInternet == ConnectivityResult.none){
                                Get.snackbar("Mode Offline", "Cannot delete Data", colorText: Colors.blue,
                                    snackPosition: SnackPosition.TOP);
                              }
                              else if(connectionInternet == ConnectivityResult.wifi || connectionInternet == ConnectivityResult.mobile) {
          ...
          onPressed: (){
            ...
            Future<List<EmployeModel>> getEmploye(filter) async {
              try {
                ...
                var response = await LocalVisiteSecuriteService().readEmployeEquipeVisiteSecuriteOffline(widget.numFiche);
                                        ...
                                        if(_addItemFormKey.currentState!.validate()){
                                          try {
                                              ...
                                              if(connection == ConnectivityResult.none){
                                                ...
                                                model.affectation = int.parse(affectation.toString());
    ...
    AwesomeDialog(
        ...
        btnOk: ElevatedButton(
          ...
          onPressed: () async {
            ...
            await VisiteSecuriteService().deleteEquipeVisiteSecuriteById(widget.numFiche, mat).then((resp) async {
              ShowSnackBar.snackBar("Successfully", "${mat} Deleted", Colors.orangeAccent);
