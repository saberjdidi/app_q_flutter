...
class TypeCauseIncidentEnvPage extends StatefulWidget {
 ...
 const TypeCauseIncidentEnvPage({Key? key, required this.numIncident}) : super(key: key);

  @override
  State<TypeCauseIncidentEnvPage> createState() => _TypeCauseIncidentEnvPageState();
}
  ...
  void getTypeCause() async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        final response = await LocalIncidentEnvironnementService().readTypeCauseRattacherEnvByIncident(widget.numIncident);
        ...
        //rest api
        await IncidentEnvironnementService().getTypeCauseByIncident(widget.numIncident, matricule, 1).then((resp) async {
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: Visibility(
                          ...
                          child: InkWell(
                              onTap: (){
                                deleteTypeCause(context, listType[index].idIncidentCause);
                              },
    ...
    AwesomeDialog(
        ...
        btnOk: ElevatedButton(
          ...
          onPressed: () async {
            ...
            await IncidentEnvironnementService().deleteTypeCauseIncidentById(id).then((resp) async {
