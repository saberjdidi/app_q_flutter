                          ...
                          child: Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Visibility(
                                      ...
                                      child: DropdownSearch<TypeReunionModel>(
                                        ...
                                        onChanged: (data) {
                                          ...
                                          print('typeReunion: ${controller.typeReunionModel?.typeReunion}, code: ${controller.selectedCodeType}');
                                        },
                                  ...
                                  SizedBox(height: 10.0,),
                                  Divider(thickness: 4, color: Color(0xFF333432),),
                                  Center(child: Text('Realisation',
                                    style: TextStyle(fontSize: 40,
                                        fontWeight: FontWeight.w600, color: Color(
                                            0xFF0769D2), fontFamily: "Signatra"),),),
                                  SizedBox(height: 10.0,),
                                  Column(
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          const Text("Non encore réalisée", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black),)
                                        ],
                                      ),
                                      Row(
                                        children: [
                                          Radio(value: 1,
                                            ...
                                            activeColor: Colors.blue,
                                            fillColor: MaterialStateProperty.all(Colors.blue),),
                                          const Text("Réalisée", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black),)
                                        ],
                                      ),
                                      Row(
                                        children: [
                                          Radio(value: 3,
                                            ...
                                            activeColor: Colors.blue,
                                            fillColor: MaterialStateProperty.all(Colors.blue),),
                                          const Text("Reportée", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black),)
                                        ],
                                      ),
                                      Row(
                                        children: [
                                          Radio(value: 2,
                                            ...
                                            activeColor: Colors.blue,
                                            fillColor: MaterialStateProperty.all(Colors.blue),),
                                          const Text("Annulée", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black),)
                                        ],
                                      ),
...
//typenc
  Future<List<TypeReunionModel>> getTypeReunion(filter) async {
    try {
      List<TypeReunionModel> _typeList = await List<TypeReunionModel>.empty(growable: true);
      List<TypeReunionModel> _typeFilter = await List<TypeReunionModel>.empty(growable: true);
  ...
  Future<List<SiteModel>> getSite(filter) async {
    try {
      ...
      if(connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var sites = await controller.localActionService.readSiteByModule("Réunion", "Réunion");
        sites.forEach((data){
          var model = SiteModel();
  ...
  Future<List<ProcessusModel>> getProcessus(filter) async {
    try {
      ...
      if(connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var sites = await controller.localActionService.readProcessusByModule("Réunion", "Réunion");
        sites.forEach((data){
  ...
  Future<List<DirectionModel>> getDirection(filter) async {
    try {
      ...
      if(connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var response = await controller.localActionService.readDirectionByModule("Réunion", "Réunion");
        response.forEach((data){
  ...
  Future<List<ServiceModel>> getService(filter) async {
    ...
    try {
      ...
      if(connection == ConnectivityResult.none) {
        ...
        var response = await controller.localActionService.readServiceByModuleAndDirection('Réunion', 'Réunion', controller.selectedCodeDirection);
        ...
        //Get.snackbar("Internet Connection", "Mode Online", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        await ApiServicesCall().getService(controller.matricule, controller.selectedCodeDirection, 'Réunion', 'Réunion')
            .then((resp) async {
          resp.forEach((data) async {
  ...
  Future<List<ActivityModel>> getActivity(filter) async {
    try {
      ...
      if(connection == ConnectivityResult.none) {
        //Get.snackbar("No Connection", "Mode Offline", colorText: Colors.blue, snackPosition: SnackPosition.TOP);
        var response = await controller.localActionService.readActivityByModule("Réunion", "Réunion");
        response.forEach((data){
