...
class DBHelper {
  ...
  _onCreatingDatabase(Database database, int version) async {
    ...
    batch.execute("CREATE TABLE ${DBTable.user}(id INTEGER PRIMARY KEY AUTOINCREMENT, mat TEXT, nompre TEXT, supeer INTEGER, change INTEGER, bloque INTEGER, login TEXT, password TEXT)");
    batch.execute("CREATE TABLE ${DBTable.resp_cloture}(id INTEGER PRIMARY KEY AUTOINCREMENT, mat TEXT, codeSite INTEGER, codeProcessus INTEGER, nompre TEXT, site TEXT, processus TEXT)");
    batch.execute("CREATE TABLE ${DBTable.site}(id INTEGER PRIMARY KEY AUTOINCREMENT, codesite INTEGER, site TEXT, module TEXT, fiche TEXT)");
    batch.execute("CREATE TABLE ${DBTable.processus}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeProcessus INTEGER, processus TEXT, module TEXT, fiche TEXT)");
    batch.execute("CREATE TABLE ${DBTable.processus_employe}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeProcessus INTEGER, processus TEXT, mat TEXT)");
    batch.execute("CREATE TABLE ${DBTable.product}(id INTEGER PRIMARY KEY AUTOINCREMENT, codePdt TEXT, produit TEXT, prix INTEGER, typeProduit TEXT, codeTypeProduit INTEGER)");
    batch.execute("CREATE TABLE ${DBTable.direction}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeDirection INTEGER, direction TEXT, module TEXT, fiche TEXT)");
    batch.execute("CREATE TABLE ${DBTable.employe}(id INTEGER PRIMARY KEY AUTOINCREMENT, mat TEXT, nompre TEXT)");
    batch.execute("CREATE TABLE ${DBTable.activity}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeDomaine INTEGER, domaine TEXT, module TEXT, fiche TEXT)");
    batch.execute("CREATE TABLE ${DBTable.service}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeService INTEGER, service TEXT, codeDirection INTEGER, module TEXT, fiche TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.priorite}(id INTEGER PRIMARY KEY AUTOINCREMENT, codepriorite INTEGER, priorite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.gravite}(id INTEGER PRIMARY KEY AUTOINCREMENT, codegravite INTEGER, gravite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.champ_cache}(id INTEGER, module TEXT, fiche TEXT, listOrder INTEGER, nomParam TEXT, visible INTEGER)");
    batch.execute("CREATE TABLE ${DBTable.fournisseur}(id INTEGER PRIMARY KEY AUTOINCREMENT, raisonSociale TEXT, activite TEXT, codeFr TEXT)");
    batch.execute("CREATE TABLE ${DBTable.client}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeclt TEXT, nomClient TEXT)");
    //-----------------------------------------Module Action-----------------------------------------------
    batch.execute("CREATE TABLE ${DBTable.source_action}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeSouceAct INTEGER, sourceAct TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_action}(id INTEGER PRIMARY KEY AUTOINCREMENT, codetypeAct INTEGER, typeAct TEXT, actSimpl INTEGER, analyseCause INTEGER)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_action}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, nAct INTEGER, idTypeCause INTEGER, codetypecause INTEGER, typecause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_action_a_rattacher}(id INTEGER PRIMARY KEY AUTOINCREMENT, codetypecause INTEGER, typecause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.audit_action}(id INTEGER PRIMARY KEY AUTOINCREMENT, idaudit INTEGER, refAudit TEXT, interne TEXT)");
    batch.execute("CREATE TABLE ${DBTable.champ_obligatoire_action}(id INTEGER PRIMARY KEY AUTOINCREMENT, commentaire_Realisation_Action INTEGER, rapport_Suivi_Action INTEGER, delai_Suivi_Action INTEGER, priorite INTEGER, gravite INTEGER, commentaire INTEGER)");
    ...
    batch.execute("CREATE TABLE ${DBTable.action}(id INTEGER PRIMARY KEY AUTOINCREMENT, nAct INTEGER, site TEXT, sourceAct TEXT, typeAct TEXT, cloture INTEGER, date TEXT, act TEXT, matdeclencheur TEXT, nomOrigine TEXT, respClot INTEGER, idAudit INTEGER, actionPlus0 TEXT, actionPlus1 TEXT, online INTEGER)");
    ...
    batch.execute("CREATE TABLE ${DBTable.type_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeTypeNC INTEGER, typeNC TEXT, color TEXT)");
    batch.execute("CREATE TABLE ${DBTable.gravite_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, nGravite INTEGER, gravite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.source_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeSourceNC INTEGER, sourceNC TEXT)");
    batch.execute("CREATE TABLE ${DBTable.atelier_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeAtelier INTEGER, atelier TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.product_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, nnc INTEGER, idNCProduct INTEGER, codeProduit TEXT, produit TEXT, numOf TEXT, numLot TEXT, qdetect INTEGER, qprod INTEGER, typeProduit TEXT, unite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, nnc INTEGER, idTypeCause INTEGER, codetypecause INTEGER, typecause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_a_rattacher_pnc}(id INTEGER PRIMARY KEY AUTOINCREMENT, codetypecause INTEGER, typecause TEXT)");
    //---------------------------------Module Reunion------------------------------------------------------
    batch.execute("CREATE TABLE ${DBTable.type_reunion}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeTypeR INTEGER, typeReunion TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.participant_reunion}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, nReunion INTEGER, mat TEXT, nompre TEXT, comment TEXT, aparticipe INTEGER, confirm INTEGER)");
    ...
    batch.execute("CREATE TABLE ${DBTable.type_document}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeType INTEGER, type TEXT)");

    //--------------------------------------Module Incident Environnement-----------------------------------------------------------------------
    batch.execute("CREATE TABLE ${DBTable.champ_obligatoire_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, incCat INTEGER, incTypecons INTEGER, incTypecause INTEGER, lieu INTEGER, desIncident INTEGER, typeIncident INTEGER, dateIncident INTEGER, actionImmediates INTEGER, descIncident INTEGER, descCauses INTEGER, gravite INTEGER)");
    ...
    batch.execute("CREATE TABLE ${DBTable.type_cause_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, idTypeCause INTEGER, typeCause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_incident_env_rattacher}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, incident INTEGER, idIncidentCause INTEGER, idTypeCause INTEGER, typeCause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.category_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, idCategorie INTEGER, categorie TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_consequence_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, idTypeConseq INTEGER, typeConseq TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_consequence_incident_env_rattacher}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, incident INTEGER, idIncidentConseq INTEGER, idTypeConseq INTEGER, typeConseq TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, idType INTEGER, typeIncident TEXT)");
    batch.execute("CREATE TABLE ${DBTable.lieu_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, code TEXT, lieu TEXT)");
    batch.execute("CREATE TABLE ${DBTable.source_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, idSource INTEGER, source TEXT)");
    batch.execute("CREATE TABLE ${DBTable.cout_estime_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, idCout INTEGER, cout TEXT)");
    batch.execute("CREATE TABLE ${DBTable.gravite_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, codegravite INTEGER, gravite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.secteur_incident_env}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeSecteur TEXT, secteur TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.poste_travail}(id INTEGER PRIMARY KEY AUTOINCREMENT, code TEXT, poste TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idType INTEGER, typeIncident TEXT)");
    batch.execute("CREATE TABLE ${DBTable.category_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idCategorie INTEGER, categorie TEXT)");
    batch.execute("CREATE TABLE ${DBTable.cause_typique_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idTypeCause INTEGER, causeTypique TEXT, idCauseTypique INTEGER)");
    batch.execute("CREATE TABLE ${DBTable.cause_typique_incident_securite_rattacher} (id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, incident INTEGER, idIncidentCauseTypique INTEGER, idCauseTypique INTEGER, causeTypique TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idTypeCause INTEGER, typeCause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_cause_incident_securite_rattacher}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, incident INTEGER, idIncidentCause INTEGER, idTypeCause INTEGER, typeCause TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_consequence_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idTypeConseq INTEGER, typeConseq TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_consequence_incident_securite_rattacher}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, incident INTEGER, idIncidentConseq INTEGER, idTypeConseq INTEGER, typeConseq TEXT)");
    batch.execute("CREATE TABLE ${DBTable.site_lesion_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeSiteLesion INTEGER, siteLesion TEXT)");
    batch.execute("CREATE TABLE ${DBTable.site_lesion_incident_securite_rattacher} (id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, incident INTEGER, idIncCodeSiteLesion INTEGER, codeSiteLesion INTEGER, siteLesion TEXT)");
    batch.execute("CREATE TABLE ${DBTable.gravite_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, codegravite INTEGER, gravite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.secteur_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeSecteur TEXT, secteur TEXT)");
    batch.execute("CREATE TABLE ${DBTable.cout_estime_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idCout INTEGER, cout TEXT)");
    batch.execute("CREATE TABLE ${DBTable.evenement_declencheur_incident_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idEvent INTEGER, event TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.check_list}(id INTEGER PRIMARY KEY AUTOINCREMENT, idCheck INTEGER, code TEXT, checklist TEXT)");
    batch.execute("CREATE TABLE ${DBTable.unite_visite_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idUnite INTEGER, code TEXT, unite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.zone_visite_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idZone INTEGER, idUnite INTEGER, code TEXT, zone TEXT)");
    batch.execute("CREATE TABLE ${DBTable.site_visite_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, codesite INTEGER, site TEXT)");
    batch.execute("CREATE TABLE ${DBTable.equipe_visite_securite}(id INTEGER PRIMARY KEY AUTOINCREMENT, affectation INTEGER, mat TEXT, nompre TEXT)");
    batch.execute("CREATE TABLE ${DBTable.equipe_visite_securite_employe}(idEquipe INTEGER PRIMARY KEY AUTOINCREMENT, id INTEGER, affectation INTEGER, mat TEXT)");
    batch.execute("CREATE TABLE ${DBTable.equipe_visite_securite_offline}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, idFiche INTEGER, affectation INTEGER, mat TEXT, nompre TEXT)");
    //---------------------------------------Module Audit-----------------------------------------
    ...
    batch.execute("CREATE TABLE ${DBTable.gravite_audit}(id INTEGER PRIMARY KEY AUTOINCREMENT, codegravite INTEGER, gravite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_constat_audit}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeType INTEGER, type TEXT)");
    batch.execute("CREATE TABLE ${DBTable.champ_audit}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeChamp INTEGER, champ TEXT, criticite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.champ_audit_constat}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, refAudit TEXT, codeChamp INTEGER, champ TEXT, criticite TEXT)");
    batch.execute("CREATE TABLE ${DBTable.type_audit}(id INTEGER PRIMARY KEY AUTOINCREMENT, codeType INTEGER, type TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.auditeur_interne}(id INTEGER PRIMARY KEY AUTOINCREMENT, online INTEGER, refAudit TEXT, mat TEXT, nompre TEXT, affectation TEXT)");
    batch.execute("CREATE TABLE ${DBTable.auditeur_interne_a_rattacher}(id INTEGER PRIMARY KEY AUTOINCREMENT, refAudit TEXT, mat TEXT, nompre TEXT)");
    ...
    batch.execute("CREATE TABLE ${DBTable.action_suite_audit}(id INTEGER PRIMARY KEY AUTOINCREMENT, nAct INTEGER, act TEXT, datsuivPrv TEXT, ind INTEGER, isd INTEGER)");
    //pnc
    batch.execute("CREATE TABLE ${DBTable.pnc_valider}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, codepdt TEXT, nlot TEXT, ind INTEGER, traitee INTEGER, dateT TEXT, dateST TEXT, ninterne TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_investigation_effectuer}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, nlot TEXT, codepdt TEXT, ind INTEGER, nomClt TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_investigation_approuver}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, nlot TEXT, codepdt TEXT, ind INTEGER, nomClt TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_decision}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, nlot TEXT, codepdt TEXT, ind INTEGER, nc TEXT, nomClt TEXT, commentaire TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_traiter}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, nlot TEXT, codepdt TEXT, ind INTEGER, traitee INTEGER, dateT TEXT, dateST TEXT, nc TEXT, nomClt TEXT, traitement TEXT, typeT TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_corriger}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, motifRefus TEXT, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, codepdt TEXT, nlot TEXT, ind INTEGER, traitee INTEGER, dateT TEXT, dateST TEXT, ninterne TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_suivre}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, traitee INTEGER, delaiTrait TEXT, nlot TEXT, codepdt TEXT, ind INTEGER, nc TEXT, nomClt TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_approbation_finale}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, nlot TEXT, codepdt TEXT, ind INTEGER, nomClt TEXT)");
    batch.execute("CREATE TABLE ${DBTable.pnc_decision_validation}(id INTEGER PRIMARY KEY AUTOINCREMENT, nnc INTEGER, dateDetect TEXT, produit TEXT, typeNC TEXT, qteDetect INTEGER, codePdt TEXT, nc TEXT, nomClt TEXT)");
    //reunion
    batch.execute("CREATE TABLE ${DBTable.reunion_informer}(id INTEGER PRIMARY KEY AUTOINCREMENT, nReunion INTEGER, typeReunion TEXT, datePrev TEXT, heureDeb TEXT, lieu TEXT)");
    batch.execute("CREATE TABLE ${DBTable.reunion_planifier}(id INTEGER PRIMARY KEY AUTOINCREMENT, nReunion INTEGER, typeReunion TEXT, datePrev TEXT, ordreJour TEXT, heureDeb TEXT, heureFin TEXT, lieu TEXT)");
    //incident environnement
    batch.execute("CREATE TABLE ${DBTable.incident_env_decision_traitement}(id INTEGER PRIMARY KEY AUTOINCREMENT, nIncident INTEGER, incident TEXT, dateDetect TEXT)");
    batch.execute("CREATE TABLE ${DBTable.incident_env_a_traiter}(id INTEGER PRIMARY KEY AUTOINCREMENT, nIncident INTEGER, incident TEXT, dateDetect TEXT)");
    batch.execute("CREATE TABLE ${DBTable.incident_env_a_cloturer}(id INTEGER PRIMARY KEY AUTOINCREMENT, nIncident INTEGER, incident TEXT, dateDetect TEXT)");
    //incident securite
    batch.execute("CREATE TABLE ${DBTable.incident_securite_decision_traitement}(id INTEGER PRIMARY KEY AUTOINCREMENT, ref INTEGER, designation TEXT, dateInc TEXT)");
    batch.execute("CREATE TABLE ${DBTable.incident_securite_a_traiter}(id INTEGER PRIMARY KEY AUTOINCREMENT, ref INTEGER, designation TEXT, dateInc TEXT)");
    batch.execute("CREATE TABLE ${DBTable.incident_securite_a_cloturer}(id INTEGER PRIMARY KEY AUTOINCREMENT, ref INTEGER, designation TEXT, dateInc TEXT)");
    //audit
    batch.execute("CREATE TABLE ${DBTable.audit_audite}(id INTEGER PRIMARY KEY AUTOINCREMENT, idAudit INTEGER, refAudit TEXT, dateDebPrev TEXT, champ TEXT, interne TEXT)");
    batch.execute("CREATE TABLE ${DBTable.audit_auditeur}(id INTEGER PRIMARY KEY AUTOINCREMENT, idAudit INTEGER, refAudit TEXT, dateDebPrev TEXT, champ TEXT, interne TEXT)");
    batch.execute("CREATE TABLE ${DBTable.rapport_audit_valider}(id INTEGER PRIMARY KEY AUTOINCREMENT, idAudit INTEGER, refAudit TEXT, champ TEXT, interne TEXT, typeA TEXT)");

    batch.execute("CREATE TABLE ${DBTable.task}(idTask INTEGER PRIMARY KEY AUTOINCREMENT, _id TEXT, fullName TEXT, email TEXT, job TEXT, createdAt TEXT)");
    batch.execute("CREATE TABLE ${DBTable.task_sync}(id INTEGER PRIMARY KEY AUTOINCREMENT, fullName TEXT, email TEXT, job TEXT)");
    await batch.commit();
  }
  ...
  readDomaineAffectationByModule(module, fiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.domaine_affectation} WHERE module = '$module' AND fiche = '$fiche'");
  ...
  Future<int> deleteTableDomaineAffectation() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.domaine_affectation}');
    return res;
  }
  //------------------------------------------------Champ Cache------------------------------------------------
  ...
  readChampCacheByModule(module, fiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.champ_cache} WHERE module = '$module' AND fiche = '$fiche'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  Future<int> deleteTableChampObligatoireAction() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.champ_obligatoire_action}');
    return res;
  }
  //------------------------------------------------Site------------------------------------------------
  ...
  readSiteByModule(module, fiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.site} WHERE module = '$module' AND fiche = '$fiche'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readProcessusByModule(module, fiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.processus} WHERE module = '$module' AND fiche = '$fiche'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readProcessusByEmploye(mat) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.processus_employe} WHERE mat = '$mat'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  Future<int> deleteTableProcessusEmploye() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.processus_employe}');
    return res;
  }
  //------------------------------------------------Product------------------------------------------------
  ...
  readResponsableClotureParams(codeSite, codeProcessus) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.resp_cloture} WHERE codeSite = '$codeSite' AND codeProcessus = '$codeProcessus'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readDirectionByModule(module, fiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.direction} WHERE module = '$module' AND fiche = '$fiche'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readActivityByModule(module, fiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.activity} WHERE module = '$module' AND fiche = '$fiche'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readServiceByModuleAndDirection(module, fiche, codeDirection) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.service} WHERE module = '$module' AND fiche = '$fiche' AND codeDirection = '$codeDirection'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  readServiceByCodeDirection(codeDirection) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.service} WHERE codeDirection = '$codeDirection'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readTypeCauseActionOffline() async {
    Database? mydb = await db;
    var response = mydb!.rawQuery("SELECT * FROM ${DBTable.type_cause_action} WHERE online = '0'");
    debugPrint('TypeCauseAction sync : $response');
    return response;
  }
  readTypeCauseActionById(nAct) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.type_cause_action} WHERE nAct = '$nAct'");
  ...
  Future<int> deleteTableTypeCauseAction() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_action}');
    return res;
  }
  getMaxNumTypeCauseAction() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idTypeCause), 0) FROM ${DBTable.type_cause_action}");
  ...
  readTypeCauseActionARattacherById(int? nAct) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT tcr.codetypecause, tcr.typecause FROM ${DBTable.type_cause_action_a_rattacher} tcr '''
  ...
  Future<int> deleteTableTypeCauseActionARattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_action_a_rattacher}');
    return res;
  }
  //Audit Action
...
//Action
  ...
  readAction() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.action} ORDER BY nAct DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  searchAction(nAction, act, type) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.action} WHERE nAct LIKE '%$nAction%' AND act LIKE '%$act%' AND typeAct LIKE '%$type%' ORDER BY nAct DESC");
    print(response);
    return response;
  }
  ...
  getMaxNumAction() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(nAct), 0) FROM ${DBTable.action}");
    print('response nact max ${response.last.values.first}');
    return response.last.values.first;
  }
  /*
...
readActionSync() async {
  Database? mydb = await db;
  var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.action_sync} ORDER BY id ASC");
  ...
  readIdActionSyncMax() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(id), 0) FROM ${DBTable.action_sync}");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
  ...
  getCountActionSync() async {
    //database connection
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.action_sync}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  readSousActionByNumAction(numAction) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.sous_action} WHERE nAct = '$numAction'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  readSousActionByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.sous_action} WHERE online = '0' ORDER BY id ASC");
  ...
  getCountSousActionOffline() async {
    //database connection
    Database? mydb = await db;
    var x = await mydb!.rawQuery("SELECT COUNT (*) from ${DBTable.sous_action} WHERE online = '0'");
  ...
  Future<int> deleteSousActionOffline() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete("DELETE FROM ${DBTable.sous_action} WHERE online = '0'");
    return res;
  }
  getMaxNumSousAction(numAction) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(nSousAct), 0) FROM ${DBTable.sous_action} WHERE nAct = '$numAction'");
  ...
  Future<int> deleteTableChampObligatoirePNC() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.champ_obligatoire_pnc}');
    return res;
  }
//------------------------------------------------Fournisseur------------------------------------------------
  ...
  readProductByNNC(int? nnc) async {
    Database? mydb = await db;
    var response = mydb!.rawQuery("SELECT * FROM ${DBTable.product_pnc} WHERE nnc = '$nnc'");
    return response;
  }
  readProductPNCByOnline() async {
    Database? mydb = await db;
    var response = mydb!.rawQuery("SELECT * FROM ${DBTable.product_pnc} WHERE online = '0'");
  ...
  getMaxNumProductPNC() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idNCProduct), 0) FROM ${DBTable.product_pnc}");
  ...
  readTypeCauseByNNC(int? nnc) async {
    Database? mydb = await db;
    var response = mydb!.rawQuery("SELECT * FROM ${DBTable.type_cause_pnc} WHERE nnc = '$nnc'");
    return response;
  }
  readTypeCauseByOnline() async {
    Database? mydb = await db;
    var response = mydb!.rawQuery("SELECT * FROM ${DBTable.type_cause_pnc} WHERE online = '0'");
  ...
  getMaxNumTypeCausePNC() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idTypeCause), 0) FROM ${DBTable.type_cause_pnc}");
  ...
  readTypeCausePNCARattacher(int? nnc) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT ${DBTable.type_cause_a_rattacher_pnc}.codetypecause, ${DBTable.type_cause_a_rattacher_pnc}.typecause FROM ${DBTable.type_cause_a_rattacher_pnc} '''
  ...
  Future<int> deleteTableTypeCausePNCARattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_a_rattacher_pnc}');
    return res;
  }
  //----------------------------------------PNC---------------------------------------------
  readPNC() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.pnc} ORDER BY nnc DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  readPNCByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.pnc} WHERE online = '0' ORDER BY nnc ASC");
  ...
  Future<int> deletePNCOffline() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete("DELETE FROM ${DBTable.pnc} WHERE online = '0'");
    return res;
  }
  getMaxNumPNC() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(nnc), 0) FROM ${DBTable.pnc}");
    print('response nact max ${response.last.values.first}');
    return response.last.values.first;
  }
  ...
  readPNCByNNC(table, itemId) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'nnc=?', whereArgs: [itemId]);
    return response;
  }
  getCountPNC() async {
    //database connection
  ...
  readReunion() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.reunion} ORDER BY nReunion DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  readReunionByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.reunion} WHERE online = '0' ORDER BY id ASC");
    debugPrint('reunion sync : $response');
    return response;
  }
  Future<int> deleteReunionOffline() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete("DELETE FROM ${DBTable.reunion} WHERE online = '0'");
    return res;
  }
  getMaxNumReunion() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(nReunion), 0) FROM ${DBTable.reunion}");
  ...
  readReunionByNumero(table, itemId) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'nReunion=?', whereArgs: [itemId]);
    return response;
  }
  ...
  readParticipantByReunion(int? nReunion) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.participant_reunion} WHERE nReunion = $nReunion");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  readParticipantReunionByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.participant_reunion} WHERE online = '0'");
  ...
  Future<int> deleteTableParticipantReunion() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.participant_reunion}');
    return res;
  }
  readEmployeParticipantReunion(int? nReunion) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT ${DBTable.employe}.mat, ${DBTable.employe}.nompre FROM ${DBTable.employe} '''
  ...
  readDocumentation() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.documentation}");
    print(response);
    return response;
  }
  searchDocumentation(code, libelle, type) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.documentation} WHERE cdi LIKE '%$code%' AND libelle LIKE '%$libelle%' AND typeDI LIKE '%$type%' ");
    print(response);
    return response;
  }
  readDocumentationByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.documentation} WHERE online = '0'");
    print(response);
    return response;
  }
  ...
  readDocumentationByCode(table, itemId) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'cdi=?', whereArgs: [itemId]);
    return response;
  }
  getCountDocumentation() async {
    //database connection
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.documentation}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //------------------------------------------------type document------------------------------------------------
  ...
  readIncidentEnvironnement() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.incident_environnement} ORDER BY n DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  searchIncidentEnvironnement(numero, type, designation) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.incident_environnement} WHERE n LIKE '%$numero%' AND type LIKE '%$type%' AND incident LIKE '%$designation%' ORDER BY n DESC");
    print(response);
    return response;
  }
  readIncidentEnvironnementByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.incident_environnement} WHERE online = '0' ORDER BY id ASC");
    debugPrint('incident environnement sync : $response');
    return response;
  }
  Future<int> deleteIncidentEnvironnementOffline() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete("DELETE FROM ${DBTable.incident_environnement} WHERE online = '0'");
    return res;
  }
  getMaxNumIncidentEnvironnement() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(n), 0) FROM ${DBTable.incident_environnement}");
  ...
  Future<int> deleteTableIncidentEnvironnement() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_environnement}');
    return res;
  }
  ...
  getCountIncidentEnvironnement() async {
    //database connection
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_environnement}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTableChampObligatoireIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.champ_obligatoire_incident_env}');
    return res;
  }
  //------------------------------------------------Type Cause------------------------------------------------
  ...
  readTypeCauseIncidentEnvARattacher(incident) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT TC.idTypeCause, TC.typeCause FROM ${DBTable.type_cause_incident_env} TC '''
  ...
  Future<int> deleteTableTypeCauseIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_incident_env}');
    return res;
  }
  //type cause inc env rattacher
  readTypeCauseIncidentEnvRattacherByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.type_cause_incident_env_rattacher} WHERE online = '0'");
    debugPrint('type cause inc env sync : $response');
    return response;
  }
  readTypeCauseRattacherEnvByIncident(table, incident) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'incident=?', whereArgs: [incident]);
    return response;
  }
  ...
  Future<int> deleteTableTypeCauseIncidentEnvRattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_incident_env_rattacher}');
    return res;
  }
  getMaxNumTypeCauseIncidentEnvironnementRattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idIncidentCause), 0) FROM ${DBTable.type_cause_incident_env_rattacher}");
  ...
  Future<int> deleteTableCategoryIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.category_incident_env}');
    return res;
  }
  //------------------------------------------------Type Consequence------------------------------------------------
  ...
  readTypeConsequenceIncidentEnvARattacher(incident) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT TC.idTypeConseq, TC.typeConseq FROM ${DBTable.type_consequence_incident_env} TC '''
  ...
  Future<int> deleteTableTypeConsequenceIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_consequence_incident_env}');
    return res;
  }
  //type Consequence inc env rattacher
  readTypeConsequenceIncidentEnvRattacherByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.type_consequence_incident_env_rattacher} WHERE online = '0'");
  ...
  Future<int> deleteTableTypeConsequenceIncidentEnvRattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_consequence_incident_env_rattacher}');
    return res;
  }
  getMaxNumTypeConsequenceIncidentEnvironnementRattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idIncidentConseq), 0) FROM ${DBTable.type_consequence_incident_env_rattacher}");
  ...
  Future<int> deleteTableTypeIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_incident_env}');
    return res;
  }
  //------------------------------------------------lieu inc------------------------------------------------
  ...
  Future<int> deleteTableLieuIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.lieu_incident_env}');
    return res;
  }
  //------------------------------------------------source incident------------------------------------------------
  ...
  Future<int> deleteTableSourceIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.source_incident_env}');
    return res;
  }
  ...
  Future<int> deleteTableCoutEstimeIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.cout_estime_incident_env}');
    return res;
  }
  //------------------------------------------------gravite inc env------------------------------------------------
  ...
  Future<int> deleteTableGraviteIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.gravite_incident_env}');
    return res;
  }
  //------------------------------------------------secteur inc------------------------------------------------
  ...
  Future<int> deleteTableSecteurIncidentEnv() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.secteur_incident_env}');
    return res;
  }
  //------------------------------------------Module Incident Securite----------------------------------
  //----------------------------------------Incident Securite------------------------------------------------
  readIncidentSecurite() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.incident_securite} ORDER BY ref DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  searchIncidentSecurite(numero, designation, type) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.incident_securite} WHERE ref LIKE '%$numero%' AND designation LIKE '%$designation%' AND typeIncident LIKE '%$type%' ORDER BY ref DESC");
    print(response);
    return response;
  }
  readIncidentSecuriteByOnline() async {
    ...
    var response = await mydb!.rawQuery(''' SELECT ref, online, dateInc, heure, codeType, codePoste, codeGravite, codeCategory, '''
  ...
  getMaxNumIncidentSecurite() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(ref), 0) FROM ${DBTable.incident_securite}");
    print('response num incident max ${response.last.values.first}');
    return response.last.values.first;
  }
  ...
  Future<int> deleteTableIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_securite}');
    return res;
  }
  readIncidentSecuriteByNumero(table, itemId) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'ref=?', whereArgs: [itemId]);
    return response;
  }
  getCountIncidentSecurite() async {
    //database connection
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_securite}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTableChampObligatoireIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.champ_obligatoire_incident_securite}');
    return res;
  }
  //------------------------------------------------poste travail------------------------------------------------
  ...
  Future<int> deleteTableTypeIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_incident_securite}');
    return res;
  }
  //------------------------------------------------category------------------------------------------------
  ...
  Future<int> deleteTableCategoryIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.category_incident_securite}');
    return res;
  }
  ...
  readTypeCauseIncSecARattacher(incident) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT TC.idTypeCause, TC.typeCause FROM ${DBTable.type_cause_incident_securite} TC '''
  ...
  Future<int> deleteTableTypeCauseIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_incident_securite}');
    return res;
  }
  //type cause inc env rattacher
  readTypeCauseIncidentSecRattacherByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.type_cause_incident_securite_rattacher} WHERE online = '0'");
  ...
  Future<int> deleteTableTypeCauseIncSecRattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_cause_incident_securite_rattacher}');
    return res;
  }
  getMaxNumTypeCauseIncSecRattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idIncidentCause), 0) FROM ${DBTable.type_cause_incident_securite_rattacher}");
    debugPrint('response idIncidentCause max : ${response.last.values.first}');
    return response.last.values.first;
  }
  ...
  readTypeConsequenceIncSecARattacher(incident) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT TC.idTypeConseq, TC.typeConseq FROM ${DBTable.type_consequence_incident_securite} TC '''
  ...
  Future<int> deleteTableTypeConsequenceIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_consequence_incident_securite}');
    return res;
  }
  //type Consequence inc sec rattacher
  readTypeConsequenceIncSecRattacherByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.type_consequence_incident_securite_rattacher} WHERE online = '0'");
  ...
  Future<int> deleteTableTypeConsequenceIncSecRattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_consequence_incident_securite_rattacher}');
    return res;
  }
  getMaxNumTypeConsequenceIncSecRattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idIncidentConseq), 0) FROM ${DBTable.type_consequence_incident_securite_rattacher}");
    debugPrint('response idIncidentConseq max : ${response.last.values.first}');
    return response.last.values.first;
  }
  //------------------------------------------------cause typique------------------------------------------------
  ...
  readCauseTypiqueIncSecARattacherByIncident(incident) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT TC.idCauseTypique, TC.causeTypique FROM ${DBTable.cause_typique_incident_securite} TC '''
  ...
  Future<int> deleteTableCauseTypiqueIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.cause_typique_incident_securite}');
    return res;
  }
  //cause typique  inc env rattacher
  readCauseTypiqueIncSecRattacherByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.cause_typique_incident_securite_rattacher} WHERE online = '0'");
  ...
  Future<int> deleteTableCauseTypiqueIncSecRattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.cause_typique_incident_securite_rattacher}');
    return res;
  }
  getMaxNumCauseTypiqueIncSecRattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idIncidentCauseTypique), 0) FROM ${DBTable.cause_typique_incident_securite_rattacher}");
    debugPrint('response idIncidentCause max : ${response.last.values.first}');
    return response.last.values.first;
  }
  ...
  readSiteLesionIncSecARattacherByIncident(incident) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT TC.codeSiteLesion, TC.siteLesion FROM ${DBTable.site_lesion_incident_securite} TC '''
  ...
  Future<int> deleteTableSiteLesionIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.site_lesion_incident_securite}');
    return res;
  }
  //site lesion rattacher
  readSiteLesionIncSecRattacher(table, incident) async {
    Database? mydb = await db;
    final response = await mydb!.query(table, where: 'incident=?', whereArgs: [incident]);
    return response;
  }
  readSiteLesionIncSecRattacherByonline() async {
    Database? mydb = await db;
    final response = await mydb!.rawQuery('SELECT * FROM ${DBTable.site_lesion_incident_securite_rattacher} WHERE online = 0 ');
  ...
  Future<int> deleteTableSiteLesionIncSecRattacher() async {
    Database? mydb = await db;
    final response = await mydb!.rawDelete('DELETE FROM ${DBTable.site_lesion_incident_securite_rattacher}');
    return response;
  }
  getMaxNumSiteLesionIncSecRattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idIncCodeSiteLesion), 0) FROM ${DBTable.site_lesion_incident_securite_rattacher}");
    debugPrint('response idIncCodeSiteLesion max : ${response.last.values.first}');
    return response.last.values.first;
  }
  ...
  Future<int> deleteTableGraviteIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.gravite_incident_securite}');
    return res;
  }
  ...
  Future<int> deleteTableSecteurIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.secteur_incident_securite}');
    return res;
  }
  ...
  Future<int> deleteTableCoutEstimeIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.cout_estime_incident_securite}');
    return res;
  }
  ...
  Future<int> deleteTableEvenementDeclencheurIncidentSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.evenement_declencheur_incident_securite}');
    return res;
  }
  //-------------------------------------------------Module Visite Securite--------------------------------
  //----------------------------------------Visite Securite------------------------------------------------
  readVisiteSecurite() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.visite_securite} ORDER BY id DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  searchVisiteSecurite(numero, unite, zone) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.visite_securite} WHERE id LIKE '%$numero%' AND unite LIKE '%$unite%' AND zone LIKE '%$zone%' ORDER BY id DESC");
    print(response);
    return response;
  }
  readVisiteSecuriteByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.visite_securite} WHERE online = '0' ORDER BY id ASC");
    debugPrint('visite securite sync : $response');
    return response;
  }
  getMaxNumVisiteSecurite() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(id), 0) FROM ${DBTable.visite_securite}");
  ...
  getCountVisiteSecurite() async {
    //database connection
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.visite_securite}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //------------------------------------------------CheckList------------------------------------------------
  ...
  Future<int> deleteTableUniteVisiteSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.unite_visite_securite}');
    return res;
  }
//------------------------------------------------Zone------------------------------------------------
  ...
  readZoneByIdUnite(idUnite) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.zone_visite_securite} WHERE idUnite = '$idUnite'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  ...
  Future<int> deleteTableZoneVisiteSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.zone_visite_securite}');
    return res;
  }
  ...
  Future<int> deleteTableSiteVisiteSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.site_visite_securite}');
    return res;
  }
  //------------------------------------------------Equipe------------------------------------------------
  ...
  Future<int> deleteTableEquipeVisiteSecurite() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.equipe_visite_securite}');
    return res;
  }
  Future<int> deleteEmployeOfEquipeVisiteSecurite(id) async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete("DELETE FROM ${DBTable.equipe_visite_securite} WHERE id = $id");
    return res;
  }
  ...
  readEquipeVisiteSecuriteEmployeById(idVisite) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT mat, affectation FROM ${DBTable.equipe_visite_securite_employe} WHERE id = '$idVisite'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
  ...
  Future<int> deleteTableEquipeVisiteSecuriteEmploye() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.equipe_visite_securite_employe}');
    return res;
  }
  ...
  readEquipeVisiteSecuriteOfflineByIdFiche(idFiche) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.equipe_visite_securite_offline} WHERE idFiche = '$idFiche'");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  readEquipeVisiteSecuriteOfflineByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.equipe_visite_securite_offline} WHERE online = '0'");
    print(response);
    return response;
  }
  ...
  Future<int> deleteTableEquipeVisiteSecuriteOffline() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.equipe_visite_securite_offline}');
    return res;
  }
  //-------------------------------------------------Module Audit--------------------------------
  //----------------------------------------Audit------------------------------------------------
  readAudit() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.audit} ORDER BY idAudit DESC");
    //var response = await mydb!.query(table, where: 'codeSite=?$codeSite');
    print(response);
    return response;
  }
  searchAudit(numero, etat, type) async {
    ...
    var response;
    if(etat == 0){
      response = await mydb!.rawQuery("SELECT * FROM ${DBTable.audit} WHERE idAudit LIKE '%$numero%' AND typeA LIKE '%$type%' ORDER BY idAudit DESC");
    }
    else {
      response = await mydb!.rawQuery("SELECT * FROM ${DBTable.audit} WHERE idAudit LIKE '%$numero%' AND etat LIKE '%$etat%' AND typeA LIKE '%$type%' ORDER BY idAudit DESC");
    }
    print(response);
    return response;
  }
  readAuditByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.audit} WHERE online = '0' ORDER BY id ASC");
    debugPrint('response audit by online : $response');
    return response;
  }
  readAuditByOnline2() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery(''' SELECT idAudit, refAudit, dateDebPrev, interne, cloture, '''
  ...
  getMaxNumAudit() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idAudit), 0) FROM ${DBTable.audit}");
  ...
  readAuditById(table, itemId) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'idAudit=?', whereArgs: [itemId]);
    return response;
  }
  getCountAudit() async {
    //database connection
  ...
  readConstatAuditByRefAudit(table, refAudit) async {
    Database? mydb = await db;
    var response = await mydb!.query(table, where: 'refAudit=?', whereArgs: [refAudit]);
    return response;
  }
  readConstatAuditByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.constat_audit} WHERE online = '0' ORDER BY idAudit ASC");
    if(kDebugMode) print('ConstatAudit DB local : $response');
    return response;
  }
  getMaxNumConstatAudit() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT IFNULL( MAX(idEcart), 0) FROM ${DBTable.constat_audit}");
  ...
  Future<int> deleteTableTypeConstatAudit() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.type_constat_audit}');
    return res;
  }
  //------------------------------------------------champ audit------------------------------------------------
  ...
  readChampAuditConstatByRefAudit(String table, refAudit) async {
    Database? mydb = await db;
    List<Map> response = await mydb!.query(table, where: 'refAudit=?', whereArgs: [refAudit]);
    return response;
  }
  readChampAuditOfConstat(refAudit) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.champ_audit_constat} WHERE refAudit = '$refAudit' ");
    print(response);
    return response;
  }
  ...
  Future<int> deleteTableChampAuditConstat() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.champ_audit_constat}');
    return res;
  }
  //------------------------------------type audit---------------------------------------
  ...
  readAuditeurInterne(refAudit) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.auditeur_interne} WHERE refAudit = '$refAudit' ");
    print(response);
    return response;
  }
  readAuditeurInterneByOnline() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.auditeur_interne} WHERE online = '0' ");
    print(response);
    return response;
  }
  ...
  Future<int> deleteTableAuditeurInterne() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.auditeur_interne}');
    return res;
  }
  ...
  readAllAuditeurInterneARattacher() async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.auditeur_interne_a_rattacher}");
    print(response);
    return response;
  }
  ...
  readAuditeurInterneARattacherByRefAudit(refAudit) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery("SELECT * FROM ${DBTable.auditeur_interne_a_rattacher} WHERE refAudit = '$refAudit' ");
  ...
  readAuditeurInterneARattacher(refAudit) async {
    Database? mydb = await db;
    var response = await mydb!.rawQuery('''SELECT DISTINCT AIR.mat, AIR.nompre FROM ${DBTable.auditeur_interne_a_rattacher} AIR '''
  ...
  Future<int> deleteTableAuditeurInterneARattacher() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.auditeur_interne_a_rattacher}');
    return res;
  }
  ...
  Future<int> deleteAllActionRealisation() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.action_realisation}');
    return res;
  }
  getCountActionRealisation() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.action_realisation}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //action suivi
  ...
  getCountActionSuivi() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.action_suivi}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteAllActionSuiteAudit() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.action_suite_audit}');
    return res;
  }
  getCountActionSuiteAudit() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.action_suite_audit}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ///PNC
  ...
  getCountPNCValider() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_valider}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //pnc a corriger
  ...
  getCountPNCACorriger() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_corriger}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTablePNCInvestigationEffectuer() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.pnc_investigation_effectuer}');
    return res;
  }
  getCountPNCInvestigationEffectuer() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_investigation_effectuer}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTablePNCInvestigationApprouver() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.pnc_investigation_approuver}');
    return res;
  }
  getCountPNCInvestigationApprouver() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_investigation_approuver}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //pnc decision
  ...
  getCountPNCDecision() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_decision}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
 //pnc a traiter
  ...
  getCountPNCATraiter() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_traiter}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //pnc a suivre
  ...
  Future<int> deleteTablePNCApprobationFinale() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.pnc_approbation_finale}');
    return res;
  }
  getCountPNCApprobationFinale() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_approbation_finale}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTablePNCDecisionValidation() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.pnc_decision_validation}');
    return res;
  }
  getCountPNCDecisionValidation() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.pnc_decision_validation}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //reunion
 //reunion informer
  ...
  Future<int> deleteTableReunionInformer() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.reunion_informer}');
    return res;
  }
  getCountReunionInformer() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.reunion_informer}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //reunion planifier
  ...
  Future<int> deleteTableReunionPlanifier() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.reunion_planifier}');
    return res;
  }
  getCountReunionPlanifier() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.reunion_planifier}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //Incident Environnement
 //Decision traitement
  ...
  Future<int> deleteTableIncidentEnvDecisionTraitement() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_env_decision_traitement}');
    return res;
  }
  getCountIncidentEnvDecisionTraitement() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_env_decision_traitement}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTableIncidentEnvATraiter() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_env_a_traiter}');
    return res;
  }
  getCountIncidentEnvATraiter() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_env_a_traiter}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTableIncidentEnvACloturer() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_env_a_cloturer}');
    return res;
  }
  getCountIncidentEnvACloturer() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_env_a_cloturer}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //Incident Securite
  ...
  Future<int> deleteTableIncidentSecuriteDecisionTraitement() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_securite_decision_traitement}');
    return res;
  }
  getCountIncidentSecuriteDecisionTraitement() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_securite_decision_traitement}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTableIncidentSecuriteATraiter() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_securite_a_traiter}');
    return res;
  }
  getCountIncidentSecuriteATraiter() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_securite_a_traiter}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  ...
  Future<int> deleteTableIncidentSecuriteACloturer() async {
    Database? mydb = await db;
    final res = await mydb!.rawDelete('DELETE FROM ${DBTable.incident_securite_a_cloturer}');
    return res;
  }
  getCountIncidentSecuriteACloturer() async {
    Database? mydb = await db;
    var x = await mydb!.rawQuery('SELECT COUNT (*) from ${DBTable.incident_securite_a_cloturer}');
    int? count = Sqflite.firstIntValue(x);
    return count;
  }
  //audit
  ...
  Future<int> deleteTableAuditAudite() async {
    Database? mydb = await db;
    final response = await mydb!.rawDelete('DELETE FROM ${DBTable.audit_audite}');
    return response;
  }
  Future<int?> getCountAuditAudite() async {
    Database? mydb = await db;
    var count = await mydb!.rawQuery('SELECT COUNT (*) FROM ${DBTable.audit_audite}');
  ...
  Future<int> deleteTableAuditAuditeur() async {
    Database? mydb = await db;
    final response = await mydb!.rawDelete('DELETE FROM ${DBTable.audit_auditeur}');
    return response;
  }
  Future<int?> getCountAuditAuditeur() async {
    Database? mydb = await db;
    var count = await mydb!.rawQuery('SELECT COUNT (*) FROM ${DBTable.audit_auditeur}');
    int? response = Sqflite.firstIntValue(count);
    return response;
  }
  ...
  Future<int> deleteTableRapportAuditAValider() async {
    Database? mydb = await db;
    final response = await mydb!.rawDelete('DELETE FROM ${DBTable.rapport_audit_valider}');
    return response;
  }
  Future<int?> getCountRapportAuditAValider() async {
    Database? mydb = await db;
    var count = await mydb!.rawQuery('SELECT COUNT (*) FROM ${DBTable.rapport_audit_valider}');
    int? response = Sqflite.firstIntValue(count);
    return response;
  }
}
