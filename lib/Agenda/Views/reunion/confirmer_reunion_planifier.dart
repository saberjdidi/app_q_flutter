...
class ConfirmerReunionPlanifier extends StatefulWidget {
  ...
  @override
  State<ConfirmerReunionPlanifier> createState() =>
      _ConfirmerReunionPlanifierState();
}
...
class _ConfirmerReunionPlanifierState extends State<ConfirmerReunionPlanifier> {
  ...
  onChangeParticipe(var value) {
    setState(() {
      participe = value;
      debugPrint('participe : ${participe}');
    });
  }
                      ...
                      children: <Widget>[
                        ...
                        Visibility(
                          ...
                          child: TextFormField(
                            ...
                            textInputAction: TextInputAction.next,
                            decoration: InputDecoration(
                                labelText: '${'heur'.tr} ${'fin'.tr}',
                                hintText: '${'heur'.tr} ${'fin'.tr}',
                                labelStyle: TextStyle(
                                  fontSize: 14.0,
                                ),
                                hintStyle: TextStyle(
                        ...
                        Visibility(
                            ...
                            child: TextFormField(
                              ...
                              textInputAction: TextInputAction.next,
                              decoration: InputDecoration(
                                labelText: 'reason_declinaition'.tr,
                                hintText: 'reason_declinaition'.tr,
                                labelStyle: TextStyle(
                                  fontSize: 14.0,
                                ),
                                hintStyle: TextStyle(
      ...
      try {
        ...
        await reunionService.validerReunionPlanifier({
          ...
          ShowSnackBar.snackBar(
              "Successfully", "Reunion success", Colors.green);
          //Get.back();
