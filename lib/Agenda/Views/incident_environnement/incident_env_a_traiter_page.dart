...
class IncidentEnvATraiterPage extends StatefulWidget {
  ...
  @override
  State<IncidentEnvATraiterPage> createState() =>
      _IncidentEnvATraiterPageState();
}
  ...
  void getIncident() async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        var response =
            await LocalIncidentEnvironnementService().readIncidentEnvATraiter();
      ...
      listIncidentInfo.map((IncidentEnvAgendaModel incidentEnvAgendaModel) {
        return DataRow(
            cells: [
              DataCell(InkWell(
                  onTap: () {
                    Get.to(ValiderIncidentEnvTraiter(
