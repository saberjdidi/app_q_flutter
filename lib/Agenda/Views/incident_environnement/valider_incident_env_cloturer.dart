...
class ValiderIncidentEnvCloturer extends StatefulWidget {
  IncidentEnvAgendaModel model;

  ValiderIncidentEnvCloturer({Key? key, required this.model}) : super(key: key);

  @override
  State<ValiderIncidentEnvCloturer> createState() => _ValiderIncidentEnvCloturerState();
}

class _ValiderIncidentEnvCloturerState extends State<ValiderIncidentEnvCloturer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text("Incident a Cloturer N° ${widget.model.nIncident}"),
        ),
  ...
  Future saveBtn() async {
    if(_addItemFormKey.currentState!.validate()){
      try {
        ...
        await IncidentEnvironnementService().validerIncidentEnvCloturer({
