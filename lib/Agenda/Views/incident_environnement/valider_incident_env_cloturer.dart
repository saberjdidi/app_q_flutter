...
class ValiderIncidentEnvCloturer extends StatefulWidget {
  ...
  @override
  State<ValiderIncidentEnvCloturer> createState() =>
      _ValiderIncidentEnvCloturerState();
}

class _ValiderIncidentEnvCloturerState
    extends State<ValiderIncidentEnvCloturer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "${'incident_a_cloturer'.tr} N° ${widget.model.nIncident}",
