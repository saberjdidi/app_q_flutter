...
class ValiderIncidentEnvDecisionTraitement extends StatefulWidget {
  ...
  ValiderIncidentEnvDecisionTraitement({Key? key, required this.model})
      : super(key: key);

  @override
  State<ValiderIncidentEnvDecisionTraitement> createState() =>
      _ValiderIncidentEnvDecisionTraitementState();
}

class _ValiderIncidentEnvDecisionTraitementState
    extends State<ValiderIncidentEnvDecisionTraitement> {
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: '${'processing'.tr} Incident',
                            labelStyle: TextStyle(
                              fontSize: 14.0,
                            ),
                            hintStyle: TextStyle(
                        ...
                        SingleChildScrollView(
                          ...
                          child: ToggleSwitch(
                            ...
                            onToggle: (index) {
                              if (index == 0) {
                                accident = 0;
                                debugPrint('accident : $accident');
                              } else if (index == 1) {
                                accident = 1;
                                debugPrint('valide : $accident');
                              } else if (index == 2) {
                                accident = 2;
                                debugPrint('valide : $accident');
                              }
    ...
    if (_dataValidation() && _addItemFormKey.currentState!.validate()) {
      try {
        ...
        await IncidentEnvironnementService()
            .validerIncidentEnvDecisionTraitement({
