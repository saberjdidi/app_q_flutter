...
class ValiderIncidentEnvTraiter extends StatefulWidget {
  ...
  @override
  State<ValiderIncidentEnvTraiter> createState() =>
      _ValiderIncidentEnvTraiterState();
}
    ...
    setState(() {
      ...
      if (traite == 1) {
        ...
        dateTraitementController.text =
            DateFormat('dd/MM/yyyy').format(dateTimeSaisie);
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "${'incident_a_traiter'.tr} N° ${widget.model.nIncident}",
                      ...
                      children: <Widget>[
                        ...
                        Visibility(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                labelText: 'Date ${'of'.tr} ${'processing'.tr}',
                                hintText: 'date',
                                labelStyle: TextStyle(
                                  fontSize: 14.0,
                                ),
