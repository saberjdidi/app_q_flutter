...
class _ActionRealisationPageState extends State<ActionRealisationPage> {
  ...
  List<ActionRealisationModel> listActionReal = List<ActionRealisationModel>.empty(growable: true);
  List<ActionRealisationModel> listFiltered = [];
  TextEditingController controller = TextEditingController();
  String _searchResult = '';

  //table
  final columns = ['N° Action','N° Sous-Action','Action', 'Taux real','Date', ''];
  int? sortColumnIndex;
                  ...
                  Card(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value){
                        setState(() {
                          _searchResult = value;
                          listFiltered = listActionReal.where((user) => user.nAct.toString().contains(_searchResult)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: [
                                            ...
                                            TextSpan(text: '${listFiltered[index].dateReal}'),
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: [
                                            ...
                                            TextSpan(text: '${listFiltered[index].nomPrenom}'),
                                      ...
                                      Padding(
                                        ...
                                        child: Text('Designation : ${listFiltered[index].act}',
                                ...
                                trailing: Container(
                                  ...
                                  child: Wrap(
                                    ...
                                    actionRealisation: listFiltered[index],
                                          ...
                                          Get.to(RemplirActionRealisation(actionRealisation: listFiltered[index]));
                                        },
                                      ...
                                      IconButton(
                                        onPressed: () async {
                                          Get.to(IntervenantsActionRealisationPage(idAction: listFiltered[index].nAct, idSousAction: listFiltered[index].nSousAct,));
                                        },
