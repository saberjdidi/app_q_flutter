...
class IntervenantsActionRealisationPage extends StatefulWidget {
  ...
  const IntervenantsActionRealisationPage(
      {Key? key, required this.idAction, required this.idSousAction})
      : super(key: key);

  @override
  State<IntervenantsActionRealisationPage> createState() =>
      _IntervenantsActionRealisationPageState();
}

class _IntervenantsActionRealisationPageState
    extends State<IntervenantsActionRealisationPage> {
  ...
  void getIntervenants() async {
    try {
      //rest api
      await ActionService()
          .getIntervenant(widget.idAction, widget.idSousAction)
          .then((resp) async {
