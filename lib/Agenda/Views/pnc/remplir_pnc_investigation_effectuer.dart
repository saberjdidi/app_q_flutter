...
class RemplirPNCInvestigationEffectuer extends StatefulWidget {
  ...
  RemplirPNCInvestigationEffectuer({Key? key, required this.nnc})
      : super(key: key);

  @override
  State<RemplirPNCInvestigationEffectuer> createState() =>
      _RemplirPNCInvestigationEffectuerState();
}

class _RemplirPNCInvestigationEffectuerState
    extends State<RemplirPNCInvestigationEffectuer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Investigation Effectuer N° ${widget.nnc}",
      ...
      try {
        ...
        await pncService.remplirPNCInvestigation({
          ...
          ShowSnackBar.snackBar(
              "Successfully", "Investigation Effectuer added", Colors.green);
          //Get.back();
  ...
  Future selectFile() async {
    try {
      ...
      setState(() {
        ...
        debugPrint('base64 file : $base64File');
      });
