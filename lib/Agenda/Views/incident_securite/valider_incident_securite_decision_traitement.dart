...
class ValiderIncidentSecuriteDecisionTraitement extends StatefulWidget {
  ...
  ValiderIncidentSecuriteDecisionTraitement({Key? key, required this.model}) : super(key: key);

  @override
  State<ValiderIncidentSecuriteDecisionTraitement> createState() => _ValiderIncidentSecuriteDecisionTraitementState();
}

class _ValiderIncidentSecuriteDecisionTraitementState extends State<ValiderIncidentSecuriteDecisionTraitement> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text("Incident N° ${widget.model.ref}"),
        ),
  ...
  Future saveBtn() async {
    if(_dataValidation() && _addItemFormKey.currentState!.validate()){
      try {
        ...
        await IncidentSecuriteService().validerIncidentSecuriteDecisionTraitement({
  ...
  Future<List<EmployeModel>> getResponsableCloture(filter) async {
    try {
      ...
      if(connection == ConnectivityResult.none) {
        ...
        await IncidentSecuriteService().getResponsableCloture(
