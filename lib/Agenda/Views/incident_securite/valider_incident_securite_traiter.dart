...
class ValiderIncidentSecuriteTraiter extends StatefulWidget {
  ...
  ValiderIncidentSecuriteTraiter({Key? key, required this.model}) : super(key: key);

  @override
  State<ValiderIncidentSecuriteTraiter> createState() => _ValiderIncidentSecuriteTraiterState();
}

class _ValiderIncidentSecuriteTraiterState extends State<ValiderIncidentSecuriteTraiter> {
