...
import 'incident_securite_a_traiter_page.dart';

class ValiderIncidentSecuriteTraiter extends StatefulWidget {
  IncidentSecuriteAgendaModel model;

  ValiderIncidentSecuriteTraiter({Key? key, required this.model})
      : super(key: key);

  @override
  State<ValiderIncidentSecuriteTraiter> createState() =>
      _ValiderIncidentSecuriteTraiterState();
}

class _ValiderIncidentSecuriteTraiterState
    extends State<ValiderIncidentSecuriteTraiter> {
  ...
  onChangeCloture(var value) {
    setState(() {
      traite = value;
      debugPrint('incident traite : ${traite}');
    });
  }
  ...
  bool _dataValidation() {
    if (rapportController.text.trim() == '' && traite == 1) {
      Message.taskErrorOrWarning(
          'warning'.tr, "${'rapport'.tr} ${'is_required'.tr}");
      return false;
    }
    return true;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text("${'incident_a_traiter'.tr} N° ${widget.model.ref}"),
        ),
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText:
                                '${'responsable'.tr} ${'of'.tr} ${'processing'.tr}',
                            hintText:
                                '${'responsable'.tr} ${'of'.tr} ${'processing'.tr}',
  ...
  Future saveBtn() async {
    if (_dataValidation() && _addItemFormKey.currentState!.validate()) {
      try {
        ...
        await IncidentSecuriteService().validerIncidentSecuriteATraiter({
          ...
          ShowSnackBar.snackBar(
              "Successfully", "Incident Traite", Colors.green);
          //Get.back();
          Get.to(IncidentSecuriteATraiterPage());
