...
class IncidentSecuriteACloturerPage extends StatefulWidget {
  ...
  @override
  State<IncidentSecuriteACloturerPage> createState() =>
      _IncidentSecuriteACloturerPageState();
}

class _IncidentSecuriteACloturerPageState
    extends State<IncidentSecuriteACloturerPage> {
        ...
        return DataRow(
            cells: [
              DataCell(GestureDetector(
                onTap: () => Get.to(ValiderIncidentSecuriteCloturer(
              ...
              DataCell(InkWell(
                  onTap: () {
                    Get.to(ValiderIncidentSecuriteCloturer(
                        model: incidentSecuriteAgendaModel));
                  },
                  child: Icon(
                    Icons.edit,
