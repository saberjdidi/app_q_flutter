  ...
  getData() async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        ...
        await AuditService().getAuditsEnTantQueAuditeur().then((response) {
          response.forEach((element) {
            setState(() {
              var model = new AuditModel();
              model.idAudit = element['idAudit'];
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            '${'Audits_en_tant_que_auditeur'.tr} : ${listAudit.length}',
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Ref N°${filterAudit[index].idAudit} : ${'confirmation_declination'.tr}',
                                                                        style: TextStyle(
                                                                        ...
                                                                        ConstrainedBox(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            style:
                                                                              ...
                                                                              backgroundColor: MaterialStateProperty.all(Color(0xFD116D1B)),
                                                                              padding: MaterialStateProperty.all(EdgeInsets.all(14)),
                                                                            ),
                                                                            icon:
                                                                                Icon(Icons.edit),
