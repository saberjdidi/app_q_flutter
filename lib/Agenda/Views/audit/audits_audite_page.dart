...
class AuditsAuditePage extends StatefulWidget {
  const AuditsAuditePage({Key? key}) : super(key: key);

  @override
  State<AuditsAuditePage> createState() => _AuditsAuditePageState();
}

class _AuditsAuditePageState extends State<AuditsAuditePage> {
  ...
  getData() async {
    try {
      ...
      if (connection == ConnectivityResult.none) {
        var response = await LocalAuditService().readAuditAudite();
        ...
        await AuditService().getAuditsEnTantQueAudite().then((response) {
          response.forEach((element) {
            setState(() {
              var model = new AuditModel();
              model.idAudit = element['idAudit'];
      ...
      ShowSnackBar.snackBar(
          'Exception', Exception.toString(), Colors.redAccent);
    }
  }
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            '${'Audits_en_tant_que_audite'.tr} : ${listAudit.length}',
                                            ...
                                            child: RichText(
                                              text: TextSpan(
                                                ...
                                                children: [
                                                  ...
                                                  TextSpan(
                                                      text:
                                                          '${filterAudit[index].champ}'),
                                                ],
                                              ),
                                            ),
                                          ),
                                          Text(
                                            '${'ref_interne'.tr} : ${filterAudit[index].interne}',
                                            style: TextStyle(
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        '${'file'.tr} Audit N°${filterAudit[index].idAudit} : ${'confirmation_declination'.tr}',
                                                                        style: TextStyle(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                                InputDecoration(
                                                                              labelText: affectation == 0 ? '${'decline_participation'.tr} *' : 'comment'.tr,
                                                                              hintText: 'comment'.tr,
                                                                            ...
                                                                            validator: (u) => affectation == 0 && commentaireController == ''
                                                                                ? "${'comment'.tr} ${'is_required'.tr}"
                                                                                : null,
                                                                            style:
                                                                        ...
                                                                        ConstrainedBox(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              if (dataValidation() && _addItemFormKey.currentState!.validate()) {
                                                                                try {
                                                                                  await AuditService().confirmeAuditEnTantqueAudite({
