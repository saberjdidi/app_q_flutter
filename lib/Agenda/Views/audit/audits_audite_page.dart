    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Audit en tant que Audité : ${listAudit.length}',
                                    ...
                                    children: <Widget>[
                                      IconButton(
                                        onPressed: () async {
                                          ...
                                          await AuditService().getConfirmAuditAudite(ref_audit, 1)
                                          .then((response){
                                            setState(() {
                                          ...
                                          //confirme/decline audite
                                           ...
                                           bool dataValidation(){
                                             if(affectation==0 && commentaireController.text.trim()==''){
                                               Message.taskErrorOrWarning("Warning", "Commentaire is required");
                                               return false;
                                             }
                                             return true;
                                           }
                                                      ...
                                                      return ListBody(
                                                        children: <Widget>[
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Center(
                                                              child: Text('Fiche Audit N°${filterAudit[index].idAudit} : Confirmation/Declination',
                                                                style: TextStyle(
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: TextFormField(
                                                                    ...
                                                                    decoration: InputDecoration(
                                                                      labelText: affectation == 0 ?'Je décline ma participation *' :'Commentaire',
                                                                    ...
                                                                    validator: (u) =>
                                                                    affectation == 0 &&  commentaireController =='' ? "Commentaire est obligatoire " : null,
